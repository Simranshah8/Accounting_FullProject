...
app.controller('ExpenseController', function ($scope, $http, $timeout, $filter, GlobalServices) {
	...
	$scope.UpdateStatus = function () {
		...
		$http({
			method: 'POST',
			url: base_url + "HR/Expenses/UpdateStatus",
	...
	$scope.GetAllExpenseDetail = function () {
		...
		$http({
			method: 'POST',
			url: base_url + "HR/Expenses/GetAllExpClaim",
			dataType: "json",
	...
	$scope.GetExpenseDetailById = function (refData) {
		...
		$http({
			method: 'POST',
			url: base_url + "HR/Expenses/GetTranExpenseClaimById",
			dataType: "json",
			data: JSON.stringify(para)
		}).then(function (res) {
			hidePleaseWait();
	...
	$scope.UpdateClearance = function () {
		...
		$http({
			method: 'POST',
			url: base_url + "HR/Expenses/UpdateAcClearance",
			headers: { 'Content-Type': undefined },
			transformRequest: function (data) {
				var formData = new FormData();
				formData.append("jsonData", angular.toJson(data.jsonData));

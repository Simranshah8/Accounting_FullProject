...
app.controller('SalaryDetailController', function ($scope, $http, $timeout, $filter, GlobalServices) {
	...
	$scope.LoadData = function () {
		...
		$http({
			...
			$scope.loadingstatus = "stop";
			if (res.data.IsSuccess && res.data.Data) {
				$scope.PayHeadingList = res.data.Data.filter(x => x.IsSalaryDetail);
			} else {
				Swal.fire(res.data.ResponseMSG);
			}
		}, function (reason) {
	...
	$scope.SaveSalaryDetail = function () {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				$http({
					method: 'POST',
					url: base_url + "HR/Transaction/SaveSalaryDetail",
	...
	$scope.GetEmployeeForSalaryDetail = function () {
		...
		$http({
			method: 'POST',
			url: base_url + "HR/Transaction/GetAllEmployeeForSalaryDetail",
			dataType: "json",
	...
	$scope.DeleteSalaryDetail = function () {
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				$http({
					method: 'POST',
					url: base_url + "HR/Transaction/DeleteSalaryDetail",
					dataType: "json",
					data: JSON.stringify(para)
				}).then(function (res) {
					hidePleaseWait();
	...
	$scope.DelSalaryDetailData = function (refData, ind) {
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				$http({
					method: 'POST',
					url: base_url + "HR/Transaction/DelSalaryDetailData",
					dataType: "json",
					data: JSON.stringify(para)
				}).then(function (res) {
					hidePleaseWait();

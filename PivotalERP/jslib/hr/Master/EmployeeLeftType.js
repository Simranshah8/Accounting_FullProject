app.controller('EmployeeLeftTypeController', function ($scope, $http, $timeout, $filter, GlobalServices) {
    ...
    $scope.confirmAction = function (beData) {
        $scope.newDet.EmployeeId = beData.EmployeeDetails.EmployeeId;
    }
    ...
    $scope.CallSaveUpdateEmployeeLeftType = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveEmployeeLeftType",
    ...
    $scope.GetAllEmployeeLeftType = function () {
        ...
        $http({
            method: 'GET',
            url: base_url + "HR/Master/GetAllEmployeeLeftType",
            dataType: "json"
        }).then(function (res) {
            hidePleaseWait();
            $scope.loadingstatus = "stop";
    ...
    $scope.getEmployeeLeftTypeById = function (refData) {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/getEmployeeLeftTypeId",
            dataType: "json",
            ...
            if (res.data.IsSuccess && res.data.Data) {
                ...
                $timeout(function () {
                    ...
                    $scope.$apply(function () {
                        ...
                        $scope.newDet.EmployeeId = res.data.Data.EmployeeId;
    ...
    $scope.DelEmployeeLeftTypeById = function (refData, ind) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $http({
                    method: 'POST',
                    url: base_url + "HR/Master/DeleteEmployeeLeftType",
                    dataType: "json",
                    data: JSON.stringify(para)
                }).then(function (res) {
                    hidePleaseWait();
    ...
    $scope.EmpLeftVerify = function () {
        $scope.loadingstatus = "running";
        showPleaseWait();
        var para = {
            EmpLeftTypeId: $scope.newDet.EmpLeftTypeId,
            VerifiedRemarks: $scope.newDet.VerifiedRemarks
        };
        $http({
            method: 'POST',
            url: base_url + "HR/Master/UpdateEmpLeftVerify",
            dataType: "json",
            data: JSON.stringify(para)
        }).then(function (res) {
            hidePleaseWait();
    ...
    $scope.EmpLeftApprove = function () {
        $scope.loadingstatus = "running";
        showPleaseWait();
        var para = {
            EmpLeftTypeId: $scope.newDet.EmpLeftTypeId,
            ApprovedRemarks: $scope.newDet.ApprovedRemarks
        };
        $http({
            method: 'POST',
            url: base_url + "HR/Master/UpdateEmpLeftApproved",
            dataType: "json",
            data: JSON.stringify(para)
        }).then(function (res) {
            hidePleaseWait();

app.controller('EmployeeController', function ($scope, $http, $timeout, $filter, GlobalServices) {
    ...
    $scope.CallSaveUpdateEmpProfile = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveEmployeeDetails",
    ...
    $scope.CallSaveUpdateEmpAdd = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveEmployeeAdd",
            headers: { 'Content-Type': undefined },
    ...
    $scope.UpdateEmpEmergency = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveEmpEmergency",
            headers: { 'Content-Type': undefined },
    ...
    $scope.UpdateOfficeDet = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveOfficeDetails",
            headers: { 'Content-Type': undefined },
    ...
    $scope.UpdatePfSsfCit = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/ModifyPfSsfCit",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
    ...
    $scope.UpdateBankDetails = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveUpdateBankDetails",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
    ...
    $scope.UpdateInsurance = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveUpdateInsurance",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
    ...
    $scope.SaveUpdateAccountDet = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveUpdateAccountDet",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
    ...
    $scope.UpdateQualification = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveUpdateQualification",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
    ...
    $scope.UpdateExperience = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveUpdateExperience",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
    ...
    $scope.UpdateSupervisor= function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveUpdateSupervisor",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
                var formData = new FormData();
                formData.append("jsonData", angular.toJson(data.jsonData));
    ...
    $scope.UpdateDocument= function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "HR/Master/SaveUpdateDocument",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
                var formData = new FormData();
                formData.append("jsonData", angular.toJson(data.jsonData));

app.controller('DeviceController', function ($scope, $http, $timeout, $filter, GlobalServices) {
	...
	$scope.sortDevice = function (keyname) {
		$scope.sortKeyDevice = keyname;   //set the sortKey to the param passed
		$scope.reverseDevice = !$scope.reverseDevice; //if true make it false and vice versa
	}

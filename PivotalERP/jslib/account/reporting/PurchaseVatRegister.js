...
app.controller("PurchaseVatRegister", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
                    ...
                    if ($scope.PeriodMonthColl) {
                        $scope.PeriodMonthColl.forEach(function (pm) {
                            if (pm.IsRunning == true) {
                                $scope.PurchaseVatRegister.SelectedMonth = pm;
                                $scope.PurchaseVatRegister.RptMonthSNo = pm.SNo;

                                $scope.PurchaseVatRegister.DateFrom_TMP = new Date(pm.FromDate);
                                $scope.PurchaseVatRegister.DateTo_TMP = new Date(pm.ToDate);
                            }
                        });
                    }
                }
    ...
    $scope.ChangePeriodMonth = function (sm) {
        if (sm) {
            $scope.PurchaseVatRegister.DateFrom_TMP = new Date(sm.FromDate);
            $scope.PurchaseVatRegister.DateTo_TMP = new Date(sm.ToDate);

        }
    }

    $scope.ChangePeriodOption = function () {
        if ($scope.PurchaseVatRegister.PeriodOPT == 2) {
            $scope.ChangePeriodMonth($scope.PurchaseVatRegister.SelectedMonth);
        }
    }
    function LoadData() {
 ...
 $scope.GenConfig = {};
        ...
        $scope.perPage = {
            PurchaseVatRegister: GlobalServices.getPerPageRow(),

        };
        $scope.currentPages = {
            PurchaseVatRegister: 1
        };
        $scope.searchData = {
            PurchaseVatRegister: ''
        };
        ...
        GlobalServices.getCostClassForRpt().then(function (res) {
            if (res.data.IsSuccess && res.data.Data) {
                ...
                if ($scope.RptCostClassColl && $scope.RptCostClassColl.length > 0) {
                    $scope.PurchaseVatRegister.RptCostClassId = $scope.RptCostClassColl[0].CostClassId;
        ...
        $scope.columnDefs = [
            {
                headerName: "Miti", width: 140, field: "VoucherDate_BS", dataType: 'DateTime', cellRenderer: 'agGroupCellRenderer',
            ...
            { headerName: "Ref.No.", width: 140, field: "RefNo", dataType: 'Text', cellStyle: { 'text-align': 'center' } },
            { headerName: "PP No.", width: 140, field: "PPNo", dataType: 'Text', cellStyle: { 'text-align': 'left' } },
            ...
            { headerName: "Vendor PAN", width: 160, field: "PanVat", dataType: 'Text', cellStyle: { 'text-align': 'left' } },
            { headerName: "Total Purchase", width: 140, field: "TotalPurchase", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "Product Name", width: 180, field: "ProductName", dataType: 'Text', cellStyle: { 'text-align': 'left' }, colId: 'colItem1',},
            { headerName: "Qty.", width: 140, field: "ActualQty", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); },  colId: 'colItem2',},
            { headerName: "UOM", width: 120, field: "Unit", dataType: 'Text', cellStyle: { 'text-align': 'right' }, colId: 'colItem3',},
            { headerName: "Item Amt.", width: 160, field: "ProductAmount", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, colId: 'colItem4', },
            { headerName: "Non Taxable Amt.", width: 170, field: "NonTaxablePurchase", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "Taxable Amt.", width: 160, field: "TaxablePurchase", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            ...
            { headerName: "Import Purchase", width: 160, field: "ImportPurchase", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "Import Vat", width: 140, field: "ImportVat", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "Capital Purchase", width: 140, field: "CapitalPurchase", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "Capital Vat", width: 140, field: "CapitalVat", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "Branch", width: 170, field: "Branch", dataType: 'Text', cellStyle: { 'text-align': 'left' } },
            { headerName: "Excise Duty", width: 160, field: "ExciseDuty", dataType: 'Text', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            ...
            { headerName: "Expenses Head", width: 150, field: "ExpensesHeading", cellStyle: { 'text-align': 'left' } },

            { headerName: "Party Invoice Date", width: 150, field: "PartyInvoiceDate", cellStyle: { 'text-align': 'left' } },
            { headerName: "Party Invoice Miti", width: 150, field: "PartyInvoiceMiti", cellStyle: { 'text-align': 'left' } },
        ...
        $scope.gridOptions = {
            ...
            onFilterChanged: function () {
                ...
                $scope.gridOptions.api.forEachNodeAfterFilterAndSort(function (node) {
                    ...
                    dt.TaxablePurchase += fData.TaxablePurchase;
                    dt.NonTaxablePurchase += fData.NonTaxablePurchase;

                    dt.ImportPurchase += fData.ExportPurchase;
                    dt.ImportVat += fData.ImportVat;
                    dt.ExciseDuty += fData.ExciseDuty;

                    dt.CapitalPurchase += fData.CapitalPurchase;
                    dt.CapitalVat += fData.CapitalVat;
    ...
    $scope.SelectedInclude = function () {
        var val = $scope.PurchaseVatRegister.IncludeVouchers;
    ...
    $scope.GetPurchaseVatRegister = function () {
        ...
        if ($scope.PurchaseVatRegister.ReportType == 2) {
        ...
        var beData =
        {
            dateFrom: dateFrom,
            dateTo: dateTo,
            VoucherId: ($scope.PurchaseVatRegister.VoucherId ? $scope.PurchaseVatRegister.VoucherId : 0),
            BranchId: ($scope.PurchaseVatRegister.BranchId ? $scope.PurchaseVatRegister.BranchId : 0),
            ReportType: $scope.PurchaseVatRegister.ReportType,
            ...
            if (res.data.IsSuccess && res.data.Data) {
                ...
                if ($scope.CustomRptColumn && $scope.CustomRptColumn.TranId > 0) {
                    ...
                    var dt = {
                        ...
                        TaxablePurchase: DataColl.sum(p1 => p1.TaxablePurchase),
                        NonTaxablePurchase: DataColl.sum(p1 => p1.NonTaxablePurchase),
                        ImportPurchase: DataColl.sum(p1 => p1.ImportPurchase),
                        ExciseDuty: DataColl.sum(p1 => p1.ExciseDuty),
                        CapitalPurchase: DataColl.sum(p1 => p1.CapitalPurchase),
                        CapitalVat: DataColl.sum(p1 => p1.CapitalVat),
                        ImportVat: DataColl.sum(p1 => p1.ImportVat),
                        TotalPurchase: DataColl.sum(p1 => p1.TotalPurchase),
                    }
                    $scope.Summary = dt;
                    var filterDataColl = [];
                    filterDataColl.push(dt);
    ...
    $scope.Print = function () {
        ...
        var sm = ($scope.PurchaseVatRegister.PeriodOPT == 2 ? $scope.PurchaseVatRegister.SelectedMonth : null);
                                            ...
                                            $http({
                                                ...
                                                if (res.data.IsSuccess && res.data.Data) {
                                                    ...
                                                    var rptPara = {
                                                        ...
                                                        Period: $scope.PurchaseVatRegister.DateFromDet.dateBS + " TO " + $scope.PurchaseVatRegister.DateToDet.dateBS,
    ...
    $scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "PurchaseRegister.xlsx");
            }

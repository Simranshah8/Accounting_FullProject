...
app.controller("StatutoryReports", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
var PrintPreviewAs = 1;
 const contextMenu = GlobalServices.createElementForMenu();
    ...
    $scope.onBtExportCSV = function () {
        var params = {
            fileName: 'StatutoryReports.csv',
            sheetName: 'StatutoryReports'
        };
 ...
 $scope.GenConfig = {};
        ...
        $timeout(function () {
            $http({
                ...
                if (comDet) {
                    $scope.StatutoryReports.DateFrom_TMP = new Date(comDet.StartDate);
                }
            }, function (errormessage) {
                alert('Unable to Delete data. pls try again.' + errormessage.responseText);
            });
        });
        $scope.StatutoryReports = {
            LedgerId: 0,
        ...
        var columnDefs = [
            {
                headerName: "Date(A.D.)", width: 140, field: "VoucherDateAD", cellRenderer: 'agGroupCellRenderer',
            ...
            {
                headerName: "Date(B.S.)", width: 140, field: "VoucherDateBS", cellRenderer: 'agGroupCellRenderer',
            ...
            { headerName: "VoucherNo", width: 180, field: "VoucherNo", cellStyle: { 'text-align': 'right' } },
            { headerName: "VoucherName", width: 180, field: "VoucherName", cellStyle: { 'text-align': 'left' } },
            { headerName: "RefNo", width: 180, field: "RefNo", cellStyle: { 'text-align': 'right' } },
            { headerName: "PartyGroup", width: 180, field: "PartyGroup", cellStyle: { 'text-align': 'left' } },
            { headerName: "PartyName", width: 180, field: "PartyName", cellStyle: { 'text-align': 'left' } },
            { headerName: "PanVat", width: 180, field: "PanVat", cellStyle: { 'text-align': 'right' } },
            { headerName: "Amount", width: 180, field: "Amount", cellStyle: { 'text-align': 'right' } },
            { headerName: "Vat", width: 180, field: "Vat", cellStyle: { 'text-align': 'right' } },
            { headerName: "Excise", width: 180, field: "Excise", cellStyle: { 'text-align': 'right' } },
            { headerName: "TDS", width: 180, field: "TDS", cellStyle: { 'text-align': 'right' } },
            { headerName: "TSC", width: 180, field: "TSC", cellStyle: { 'text-align': 'right' } },
            { headerName: "Freight", width: 180, field: "Freight", cellStyle: { 'text-align': 'right' } },
            { headerName: "Discount", width: 180, field: "Discount", cellStyle: { 'text-align': 'right' } },
            { headerName: "Scheme", width: 180, field: "Scheme", cellStyle: { 'text-align': 'right' } },
            { headerName: "Insurance", width: 180, field: "Insurance", cellStyle: { 'text-align': 'right' } },
            { headerName: "CST", width: 180, field: "CST", cellStyle: { 'text-align': 'right' }},
            { headerName: "RoundOff", width: 180, field: "Freight", cellStyle: { 'text-align': 'right' } },
            { headerName: "Others", width: 180, field: "OthersAmt", cellStyle: { 'text-align': 'right' } },
        ...
        $scope.gridOptions = {
            ...
            onFilterChanged: function () {
                ...
                $scope.gridOptions.api.forEachNodeAfterFilterAndSort(function (node) {
                    if (node.data.PanVat == 1 || node.data.PanVat == 'DR')
                        Opening += node.data.InvoiceAmount;
                    else
                        Opening -= node.data.InvoiceAmount;
                });
                ...
                $scope.dataForBottomGrid[0].InvoiceAmt = InvoiceAmt;
                $scope.dataForBottomGrid[0].PanVat = drcr;
...
$timeout(function () {
    ...
    $scope.GetStatutoryReports = function () {

        var dateFrom = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));
        var dateTo = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));

        if ($scope.StatutoryReports.DateFromDet)
            dateFrom = new Date(($filter('date')($scope.StatutoryReports.DateFromDet.dateAD, 'yyyy-MM-dd')));

        if ($scope.StatutoryReports.DateToDet)
            dateTo = new Date(($filter('date')($scope.StatutoryReports.DateToDet.dateAD, 'yyyy-MM-dd')));
        ...
        var beData = {
            ...
            DateFrom: dateFrom,
            DateTo: dateTo,
            isDebtor: $scope.StatutoryReports.isDebtor,
        };
        ...
        $http({
            method: "post",
            url: base_url + "Account/Reporting/GetStatutoryReports",
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "StatutoryReports.xlsx");
            }

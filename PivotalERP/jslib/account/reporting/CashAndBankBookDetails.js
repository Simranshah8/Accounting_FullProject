...
app.controller("CashAndBankBookDetailsCntrl", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
 var PrintPreviewAs = 1;
  const contextMenu = GlobalServices.createElementForMenu();
    ...
    $scope.GenConfig = {};
        ...
        $scope.columnDefs = [
            {
                headerName: "Date(A.D.)", width: 250, cellRenderer: 'agGroupCellRenderer',cellStyle:{'text-align':'center'},
            ...
            {
                headerName: "Date(B.S.)", width: 250,cellStyle:{'text-align':'center'}, valueGetter: function (params) {
                    var beData = params.data;
                    if (beData.IsParent) {
            ...
            { headerName: "Voucher No.", width: 250, field: "AutoManualNo", filter: 'agTextColumnFilter',cellStyle:{'text-align':'center'} },
            { headerName: "Ref.No.", width: 250, field: "RefNo", filter: 'agTextColumnFilter',cellStyle:{'text-align':'center'} },
            {
                headerName: "Debit", width: 250, filter: "agNumberColumnFilter",
                valueGetter: function (params) {
                    var beData = params.data;
            ...
            {
                headerName: "Credit", width: 250, filter: "agNumberColumnFilter",
                valueGetter: function (params) {
                    var beData = params.data;
                    if (beData.IsParent) {
            ...
            {
                headerName: "Current Closing", width: 250, filter: "agNumberColumnFilter",
                valueGetter: function (params) {
                    var beData = params.data;
                    if (beData.IsParent) {
            ...
            { headerName: "CostClass", width: 250, field: "CostClassName" },
            { headerName: "User", width: 250, field: "UserName" },
            {
...
$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "CashAndBankBookDetails.xlsx");
            }

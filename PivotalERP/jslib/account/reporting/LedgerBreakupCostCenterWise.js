...
app.controller("LedgerBreakupCostCenterWise", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
var PrintPreviewAs = 1;
 const contextMenu = GlobalServices.createElementForMenu();
    LoadData();
    $scope.onBtExportCSV = function () {
        var params = {
            fileName: 'LedgerBreakupCostCenterWise.csv',
            sheetName: 'LedgerBreakupCostCenterWise'
        };
    ...
    function LoadData() {
        $scope.LedgerBreakupCostCenterWise = {
        ...
        $timeout(function () {
            $http({
                ...
                if (comDet) {
                    $scope.LedgerBreakupCostCenterWise.DateFrom_TMP = new Date(comDet.StartDate);
                }
        ...
        $scope.columnDefs = [
            ...
            { headerName: "CostCenter", width: 180, field: "Group", filter: 'agTextColumnFilter',cellStyle:{'text-align':'left'} },
            
            { headerName: "Opening", width: 120, field: "Opening", filter: 'agTextColumnFilter',cellStyle:{'text-align':'right'} },
            { headerName: "DrAmt", width: 120, field: "DrAmt", filter: 'agTextColumnFilter',cellStyle:{'text-align':'right'} },
            { headerName: "CrAmt", width: 120, field: "CrAmt", filter: 'agTextColumnFilter',cellStyle:{'text-align':'right'} },
            { headerName: "ClosingCr", width: 180, field: "ClosingCr", filter: 'agTextColumnFilter',cellStyle:{'text-align':'right'}},
            { headerName: "ClosingDr", width: 180, field: "ClosingDr", filter: 'agTextColumnFilter', cellStyle:{'text-align':'right'}},
            { headerName: "Closing", width: 120, field: "Closing", filter: 'agTextColumnFilter',cellStyle:{'text-align':'right'} },
...
$timeout(function () {
    ...
    $scope.ClearData = function () {
        ...
        $scope.LedgerBreakupCostCenterWise.ODr = 0;
        $scope.LedgerBreakupCostCenterWise.OCr = 0;
        $scope.LedgerBreakupCostCenterWise.TDr = 0;
        $scope.LedgerBreakupCostCenterWise.TCr = 0;
        $scope.LedgerBreakupCostCenterWise.CDr = 0;
        $scope.LedgerBreakupCostCenterWise.CCr = 0;
    ...
    $scope.GetLedgerBreakupCostCenterWise = function () {

        $scope.ClearData();

        if (!$scope.LedgerBreakupCostCenterWise.AgentId)
            return;

        var dateFrom = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));
        var dateTo = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));

        if ($scope.LedgerBreakupCostCenterWise.DateFromDet)
            dateFrom = new Date(($filter('date')($scope.LedgerBreakupCostCenterWise.DateFromDet.dateAD, 'yyyy-MM-dd')));

        if ($scope.LedgerBreakupCostCenterWise.DateToDet)
            dateTo = new Date(($filter('date')($scope.LedgerBreakupCostCenterWise.DateToDet.dateAD, 'yyyy-MM-dd')));
        ...
        var beData = {
            DateFrom: dateFrom,
            DateTo: dateTo,
            LedgerId: $scope.LedgerBreakupCostCenterWise.LedgerId,
            BranchIdColl: $scope.LedgerBreakupCostCenterWise.BranchIdColl
        };
        ...
        $http({
            method: "post",
            url: base_url + "Account/Reporting/GetLedgerBreakupCostCenterWise",
            ...
            $scope.LedgerBreakupCostCenterWise.ODr = (openingAmt > 0 ? openingAmt : 0);
            $scope.LedgerBreakupCostCenterWise.OCr = (openingAmt < 0 ? Math.abs(openingAmt) : 0);
            $scope.LedgerBreakupCostCenterWise.TDr = drAmt;
            $scope.LedgerBreakupCostCenterWise.TCr = crAmt;
            $scope.LedgerBreakupCostCenterWise.CDr = (closingAmt > 0 ? closingAmt : 0);
            $scope.LedgerBreakupCostCenterWise.CCr = (closingAmt < 0 ? Math.abs(closingAmt) : 0);
                                ...
                                return new Promise((resolve) => {
                                    if (value >= 0) {
                                        ...
                                        if (rptTranId > 0) {
                                            ...
                                            $http({
                                                method: 'POST',
                                                url: base_url + "Account/Reporting/PrintLedgerBreakupCostCenterWise",
                                                ...
                                                if (res.data.IsSuccess && res.data.Data) {
                                                    ...
                                                    var rptPara = {
                                                        ...
                                                        Period: $scope.LedgerBreakupCostCenterWise.DateFromDet.dateBS + " TO " + $scope.LedgerBreakupCostCenterWise.DateToDet.dateBS,
                                                        ODr: $scope.LedgerBreakupCostCenterWise.ODr,
                                                        OCr: $scope.LedgerBreakupCostCenterWise.OCr,
                                                        TDr: $scope.LedgerBreakupCostCenterWise.TDr,
                                                        TCr: $scope.LedgerBreakupCostCenterWise.TCr,
                                                        CDr: $scope.LedgerBreakupCostCenterWise.CDr,
                                                        CCr: $scope.LedgerBreakupCostCenterWise.CCr
                                                    };
    ...
    $scope.GetDataForPrint = function () {
        ...
        RptParamentersColl.push({
            ...
            {
                Name: 'Ledger',
                Value: $scope.LedgerBreakupCostCenterWise.LedgerDetails.Name
            },
            {
                Name: 'Address',
                Value: ($scope.LedgerBreakupCostCenterWise.LedgerDetails.Address ? $scope.LedgerBreakupCostCenterWise.LedgerDetails.Address : '')
            },
            {
                Name: 'MobileNo',
                Value: ($scope.LedgerBreakupCostCenterWise.LedgerDetails.MobileNo1 ? $scope.LedgerBreakupCostCenterWise.LedgerDetails.MobileNo1 : '')
            },
            {
                Name: 'PanVatNo',
                Value: ($scope.LedgerBreakupCostCenterWise.LedgerDetails.PanVat ? $scope.LedgerBreakupCostCenterWise.LedgerDetails.PanVat : '')
            },
            {
                Name: 'TelNo',
                Value: ($scope.LedgerBreakupCostCenterWise.LedgerDetails.MobileNo2 ? $scope.LedgerBreakupCostCenterWise.LedgerDetails.MobileNo2 : '')
            },
            {
                Name: 'EmailId',
                Value: ($scope.LedgerBreakupCostCenterWise.LedgerDetails.EmailId ? $scope.LedgerBreakupCostCenterWise.LedgerDetails.EmailId : '')
            },
            {
                Name: 'ODr',
...
$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "LedgerBreakupCostCenterWise.xlsx");
            }

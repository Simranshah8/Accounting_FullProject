 ...
 const contextMenu = GlobalServices.createElementForMenu();
    ...
    function LoadData() {
        ...
        var columnDefs = [
            ...
            { headerName: "Total Return", width: 140, field: "TotalPurchase", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "Product Name", width: 180, field: "ProductName", cellStyle: { 'text-align': 'left' } ,colId: 'colItem1', },
            { headerName: "Qty.", width: 140, field: "ActualQty", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, colId: 'colItem2', },
            { headerName: "UOM", width: 120, field: "Unit", cellStyle: { 'text-align': 'right' }, colId: 'colItem3', },
            { headerName: "Item Amt.", width: 160, field: "ProductAmount", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, colId: 'colItem4', },
...
$timeout(function () {
    ...
    $scope.GetPurchaseVatRegister = function () {
        ...
        if ($scope.PurchaseVatRegister.DateFromDet)
            dateFrom = $filter('date')($scope.PurchaseVatRegister.DateFromDet.dateAD, 'yyyy-MM-dd');

        if ($scope.PurchaseVatRegister.DateToDet)
            dateTo = $filter('date')($scope.PurchaseVatRegister.DateToDet.dateAD, 'yyyy-MM-dd');
        ...
        $http({
            method: "post",
            url: base_url + "Account/Reporting/GetPurchaseReturnVatRegister",
    ...
    $scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "PurchaseReturnRegister.xlsx");
            }

...
app.controller("ledgerAnalysisCtrl", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
var PrintPreviewAs = 1;
 ...
 $scope.GenConfig = {};
        ...
        var columnDefs = [
            ...
            { headerName: "Group", width: 160, field: "LedgerGroup", cellStyle: { 'text-align': 'left' }, datatype: 'string', pinned: 'left' },
            ...
            { headerName: "Agent", width: 140, field: "Agent", cellStyle: { 'text-align': 'left' }, datatype: 'string' },
            { headerName: "Party", width: 150, field: "Party", cellStyle: { 'text-align': 'left' }, datatype: 'string' },
...
$timeout(function () {
    ...
    $scope.GetProductGroupSummary = function () {
        ...
        $http({
            method: "POST",
            url: base_url + "Account/Reporting/GetLedgerAnalysis",
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "ledgerAnalysis.xlsx");
            }

 ...
 var PrintPreviewAs = 1;
  const contextMenu = GlobalServices.createElementForMenu();
	...
	$scope.toggleExpandCollapse = function () {
		if ($scope.newBalanceSheetAsT.ExpandCollapse == true) {
	...
	function getterAndSetter() {
		$scope.columnDefs = [
			...
			{ headerName: "Opening", field: "OpeningAmt", width: 150, filter: "agNumberColumnFilter", dataType: 'Number', valueFormatter: function (params) { return Numberformat(params.value); }, cellStyle: { 'text-align': 'right' }, },
			{ headerName: "Transaction", field: "TransactionAmt", width: 150, filter: 'agTextColumnFilter', dataType: 'Number', valueFormatter: function (params) { return Numberformat(params.value); }, cellStyle: { 'text-align': 'right' }, },
			{ headerName: "Closing", field: "ClosingAmt", width: 150, dataType: 'Number', valueFormatter: function (params) { return Numberformat(params.value); }, cellStyle: { 'text-align': 'right' }, },
			{
				headerName: "Action",
				width: 50,
		...
		$scope.columnDefs1 = [
			...
			{ headerName: "Opening", field: "OpeningAmt", width: 150, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, cellStyle: { 'text-align': 'right' }, },
 ...
 $scope.GenConfig = {};
	...
	$scope.LoadReport = function () {
		...
		var para = {
			dateFrom: dateFrom,
			dateTo: dateTo,
			branchIdColl: ($scope.newBalanceSheetAsT.BranchId ? $scope.newBalanceSheetAsT.BranchId.toString() : ''),
			projectIdColl: ($scope.newBalanceSheetAsT.projectIdColl ? $scope.newBalanceSheetAsT.projectIdColl.toString() : ''),
		};

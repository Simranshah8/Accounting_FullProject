...
app.controller("LedgerGroupWise", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
 ...
 $scope.GenConfig = {};
        ...
        $timeout(function () {
            $http({
                ...
                if (comDet) {
                    $scope.LedgerGroupWise.DateFrom_TMP = new Date(comDet.StartDate);
                }
            }, function (errormessage) {
                alert('Unable to Delete data. pls try again.' + errormessage.responseText);
            });
        });
        $scope.LedgerGroupWise = {
            LedgerGroupId: null,
        ...
        var columnDefs = [
            ...
            { headerName: "Ledger", width: 190, field: "Ledger",cellStyle: { 'text-align': 'left' } },
            { headerName: "LedgerGroup", width: 190, field: "LedgerGroup" ,cellStyle: { 'text-align': 'left' }},
            { headerName: "Opening", width: 190, field: "Opening",cellStyle: { 'text-align': 'right' } },
            { headerName: "ReceiptCredit", width: 190, field: "ReceiptCredit",cellStyle: { 'text-align': 'right' } },
            { headerName: "ReceiptDebit", width: 190, field: "ReceiptDebit",cellStyle: { 'text-align': 'right' } },
            { headerName: "PaymentCredit", width: 190, field: "PaymentCredit" ,cellStyle: { 'text-align': 'right' }},
            { headerName: "PaymentDebit", width: 190, field: "PaymentDebit",cellStyle: { 'text-align': 'right' } },
            { headerName: "JournalCredit", width: 190, field: "JournalCredit",cellStyle: { 'text-align': 'right' } },
            { headerName: "JournalDebit", width: 190, field: "JournalDebit" ,cellStyle: { 'text-align': 'right' }},
            { headerName: "ContraCredit", width: 190, field: "ContraCredit",cellStyle: { 'text-align': 'right' } },
            { headerName: "ContraDebit", width: 190, field: "ContraDebit",cellStyle: { 'text-align': 'right' } },
            { headerName: "ConsumptionCredit", width: 190, field: "ConsumptionCredit",cellStyle: { 'text-align': 'right' } },
            { headerName: "ConsumptionDebit", width: 190, field: "ConsumptionDebit",cellStyle: { 'text-align': 'right' } },
            { headerName: "SalesCredit", width: 190, field: "SalesCredit" ,cellStyle: { 'text-align': 'right' }},
            { headerName: "SalesDebit", width: 190, field: "SalesDebit",cellStyle: { 'text-align': 'right' } },
            { headerName: "SalesReturnCredit", width: 250, field: "SalesReturnCredit" ,cellStyle: { 'text-align': 'right' }},
            { headerName: "SalesReturnDebit", width: 250, field: "SalesReturnDebit",cellStyle: { 'text-align': 'right' } },
            { headerName: "PurchaseCredit", width: 250, field: "PurchaseCredit",cellStyle: { 'text-align': 'right' } },
            { headerName: "PurchaseDebit", width: 250, field: "PurchaseDebit",cellStyle: { 'text-align': 'right' } },
            { headerName: "PurchaseReturnDebit", width: 250, field: "PurchaseReturnDebit",cellStyle: { 'text-align': 'right' } },
            { headerName: "PurchaseReturnCredit", width: 250, field: "PurchaseReturnCredit" ,cellStyle: { 'text-align': 'right' }},
            { headerName: "TotalCredit", width: 250, field: "TotalCredit",cellStyle: { 'text-align': 'right' } },
            { headerName: "TotalDebit", width: 250, field: "TotalDebit" ,cellStyle: { 'text-align': 'right' }},
            { headerName: "Total Balance", width: 250, field: "Balance",cellStyle: { 'text-align': 'right' } },
        ...
        $scope.gridOptions = {
            ...
            onFilterChanged: function () {
                ...
                $scope.gridOptions.api.forEachNodeAfterFilterAndSort(function (node) {
                    if (node.data.Closing == 1 || node.data.Closing == 'DR')
                ...
                $scope.dataForBottomGrid[0].Closing = drcr;
...
$timeout(function () {
    ...
    $scope.GetLedgerGroupWise = function () {

        var dateFrom = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));
        var dateTo = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));

        if ($scope.LedgerGroupWise.DateFromDet)
            dateFrom = new Date(($filter('date')($scope.LedgerGroupWise.DateFromDet.dateAD, 'yyyy-MM-dd')));

        if ($scope.LedgerGroupWise.DateToDet)
            dateTo = new Date(($filter('date')($scope.LedgerGroupWise.DateToDet.dateAD, 'yyyy-MM-dd')));

        $scope.DataColl = []; //declare an empty array
        $scope.gridOptions.api.setRowData($scope.DataColl);

        var beData = {
            LedgerGroupId: $scope.LedgerGroupWise.LedgerGroupId,
            DateFrom: dateFrom,
            DateTo: dateTo,
        ...
        $http({
            method: "post",
            url: base_url + "Account/Reporting/GetTransactionSummary",
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "LedgerGroupWise.xlsx");
            }

...
app.controller("TrailBalanceLedgerwise", function ($scope, $http, $filter, $timeout,GlobalServices) {
...
var PrintPreviewAs = 1;
 ...
 $scope.GenConfig = {};
        ...
        var columnDefs = [
            ...
            { headerName: "Code", field: "Code", filter: "agTextColumnFilter", width: 100, pinned: 'left',cellStyle:{'text-align':'center'} },

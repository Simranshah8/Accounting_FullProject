...
var PrintPreviewAs = 1;
 const contextMenu = GlobalServices.createElementForMenu();
    ...
    $scope.toggleExpandCollapse = function () {
        if ($scope.newProfitAndLoss.ExpandCollapse == true) {
	...
	function getterAndSetter() {
		$scope.columnDefs = [
            ...
            {
                headerName: "Opening", field: "OpeningAmt", width: 250, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, cellStyle: { 'text-align': 'right' }, headerClass: 'text-center',
            },
			{ headerName: "Transaction", field: "TransactionAmt", width: 250, filter: 'agTextColumnFilter', valueFormatter: function (params) { return Numberformat(params.value); }, cellStyle: { 'text-align': 'right' }, },
            { headerName: "Closing", field: "ClosingAmt", width: 250, valueFormatter: function (params) { return Numberformat(params.value); }, cellStyle: { 'text-align': 'right' }, },
            {
                headerName: "Action",
                width: 50,
	...
	$scope.LoadReport = function () {
		...
		var para = {
			dateFrom: dateFrom,
            dateTo: dateTo,            
            branchIdColl: ($scope.newProfitAndLoss.BranchId ? $scope.newProfitAndLoss.BranchId.toString() : ''),
            projectIdColl: ($scope.newProfitAndLoss.projectIdColl ? $scope.newProfitAndLoss.projectIdColl.toString() : ''),
        };

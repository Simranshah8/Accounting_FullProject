...
app.controller("SalesManCommission", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
var PrintPreviewAs = 1;
 const contextMenu = GlobalServices.createElementForMenu();
    ...
    $scope.onBtExportCSV = function () {
        var params = {
            fileName: 'SalesManCommission.csv',
            sheetName: 'SalesMan Commission Summary'
        };
 ...
 $scope.GenConfig = {};
        ...
        $scope.VoucherSearchOptions = [
            { text: 'Agent', value: 'Name', dataType: 'text' },
            { text: 'AreaName', value: 'AreaName', dataType: 'text' },
            { text: 'Sales Amount', value: 'SalesAmount', dataType: 'Number' },
            { text: 'Return Amount', value: 'ReturnAmount', dataType: 'Number' },
            { text: 'Actual Sales', value: 'ActualSales', dataType: 'Number' },
            { text: 'CommissionRate', value: 'CommissionRate', dataType: 'Number' },
            { text: 'Commission Amt', value: 'CommissionAmount', dataType: 'Number' },
            { text: 'Address', value: 'Address', dataType: 'Number' },
            { text: 'Mobile No', value: 'MobileNo', dataType: 'Number' },
            { text: 'Phone No', value: 'PhoneNo', dataType: 'Number' },];
        ...
        { text: 'Closing Cr', value: 'ClosingCr', dataType: 'Number' },
            { text: 'AgentName', value: 'Name', dataType: 'text' },
            { text: 'AreaName', value: 'AreaName', dataType: 'text' },
        ];
        ...
        var columnDefs = [
            { headerName: "Agent", width: 250, field: "Name", cellStyle: { 'text-align': 'left' } },
            { headerName: "AreaName", width: 250, field: "AreaName", cellStyle: { 'text-align': 'left' } },
            { headerName: "Sales Amount", width: 250, field: "SalesAmount", cellStyle: { 'text-align': 'right' } },
            { headerName: "Return Amount", width: 250, field: "ReturnAmount", cellStyle: { 'text-align': 'right' } },
            { headerName: "Actual Sales", width: 250, field: "ActualSales", cellStyle: { 'text-align': 'right' } },
            { headerName: "Commission Rate", width: 250, field: "CommissionRate", cellStyle: { 'text-align': 'right' } },
            { headerName: "Commission Amount", width: 250, field: "CommissionAmount", cellStyle: { 'text-align': 'right' } },
            { headerName: "Address", width: 250, field: "Address", cellStyle: { 'text-align': 'left' } },
            { headerName: "Mobile No", width: 250, field: "MobileNo", cellStyle: { 'text-align': 'right' } },
            { headerName: "Phone No", width: 250, field: "PhoneNo", cellStyle: { 'text-align': 'right' } },
            {
        ...
        $scope.gridOptions = {
            ...
            onFilterChanged: function () {
                ...
                $scope.gridOptions.api.forEachNodeAfterFilterAndSort(function (node) {
                    if (node.data.SalesAmount == 1 || node.data.SalesAmount == 'DR')
                        Opening += node.data.SalesAmount;
                    else
                        Opening -= node.data.SalesAmount;
                });
                ...
                $scope.dataForBottomGrid[0].SalesAmount = Opening;
...
$timeout(function () {
    ...
    $scope.GetSalesManCommission = function () {

        var dateFrom = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));
        var dateTo = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));

        if ($scope.SalesManCommission.DateFromDet)
            dateFrom = new Date(($filter('date')($scope.SalesManCommission.DateFromDet.dateAD, 'yyyy-MM-dd')));

        if ($scope.SalesManCommission.DateToDet)
            dateTo = new Date(($filter('date')($scope.SalesManCommission.DateToDet.dateAD, 'yyyy-MM-dd')));
        ...
        $http({
            method: "POST",
            url: base_url + "Account/Reporting/GetAllSalesManCommission",
            ...
            if (res.data.IsSuccess && res.data.Data) {
                ...
                angular.forEach($scope.DataColl, function (dc) {
                    if (dc.SalesAmount == 1 || dc.SalesAmount == 'DR')
                        Opening += dc.SalesAmount;
                    else
                        Opening -= dc.SalesAmount;
                });
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "SalesManCommission.xlsx");
            }

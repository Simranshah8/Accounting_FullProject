...
app.controller("ChequeDetailsListController", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
 var PrintPreviewAs = 1;
  const contextMenu = GlobalServices.createElementForMenu();
    ...
    $scope.onBtExportCSV = function () {
        var params = {
            fileName: 'ChequeDetailsList.csv',


            sheetName: 'ChequeDetailsList'
        };
  ...
  $scope.GenConfig = {};
        ...
        $scope.VoucherSearchOptions = [
            ...
            { text: 'CostCenter', value: 'CostClass', dataType: 'text' },
            { text: 'Branch', value: 'Branch', dataType: 'text' },
            { text: 'Narration', value: 'Narration', dataType: 'text' },
            { text: 'Ledger Narration', value: 'LedgerNarration', dataType: 'text' },
            { text: 'RefNo', value: 'RefNo', dataType: 'text' },
            { text: 'LedgerCode', value: 'LedgerCode', dataType: 'Number' },
            { text: 'Account No', value: 'AccountNo', dataType: 'Number' },
            { text: 'Clearance Date', value: 'ClearanceDate', dataType: 'Date' },
            { text: 'Clearance By', value: 'ClearanceBy', dataType: 'text' },
            { text: 'Clearance Remarks', value: 'ClearanceRemarks', dataType: 'Text' },
        ];
        ...
        $scope.ReportTypeColl = GlobalServices.getReportType();
        $scope.FilterColumnColl = [{ text: 'DebitAmount', value: 'DrAmount', dataType: 'Number' },
        { text: 'Credit Amount', value: 'CrAmount', dataType: 'Number' },
        { text: 'Voucher No', value: 'VoucherNo', dataType: 'Number' },
        { text: 'AutoVoucher No', value: 'AutoVoucherNo', dataType: 'Number' },
        { text: 'CostClass Name', value: 'CostClass', dataType: 'Number' },
        { text: 'ChequeNo', value: 'ChequeNo', dataType: 'Number' },
        { text: 'Narration', value: 'Narration', dataType: 'text' },
        { text: 'LedgerNarration', value: 'LedgerNarration', dataType: 'text' },
        { text: 'Branch', value: 'Branch', dataType: 'text' },
        ...
        var columnDefs = [
            ...
            { headerName: "ChequeDate", width: 250, field: "ChequeDate",cellStyle:{'text-align':'center'} },
            { headerName: "Remarks", width: 250, field: "Remarks",cellStyle:{'text-align':'left'} },
            { headerName: "VoucherType", width: 250, field: "VoucherType",cellStyle:{'text-align':'left'} },
            { headerName: "Voucher", width: 250, field: "Voucher",cellStyle:{'text-align':'left'} },
            { headerName: "VoucherNo", width: 250, field: "VoucherNo",cellStyle:{'text-align':'center'} },
            { headerName: "AutoVoucherNo", width: 250, field: "AutoVoucherNo",cellStyle:{'text-align':'center'} },
            { headerName: "Debit Amount", width: 250, field: "DrAmount",cellStyle:{'text-align':'right'} },
            { headerName: "Credit Amount", width: 250, field: "CrAmount",cellStyle:{'text-align':'right'} },
            { headerName: "Cost Center", width: 250, field: "CostClass",cellStyle:{'text-align':'left'} },
            { headerName: "Branch", width: 250, field: "Branch",cellStyle:{'text-align':'left'} },
            { headerName: "Narration", width: 250, field: "Narration",cellStyle:{'text-align':'left'} },
            { headerName: "Ledger Narration", width: 250, field: "LedgerNarration",cellStyle:{'text-align':'left'} },
            { headerName: "RefNo", width: 250, field: "RefNo",cellStyle:{'text-align':'center'} },
            { headerName: "LedgerCode", width: 250, field: "LedgerCode",cellStyle:{'text-align':'left'} },
            { headerName: "AccountNo", width: 250, field: "AccountNo",cellStyle:{'text-align':'center'} },
            { headerName: "Clearance Date", width: 250, field: "ClearanceDate",cellStyle:{'text-align':'center'} },
            { headerName: "Clearance By", width: 250, field: "ClearanceBy",cellStyle:{'text-align':'left'} },
            { headerName: "Clearance Remarks", width: 250, field: "ClearanceRemarks",cellStyle:{'text-align':'left'} },
...
$timeout(function () {
    ...
    $scope.GetChequeDetailsList = function () {

        var dateFrom = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));
        var dateTo = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));

        if ($scope.ChequeDetailsList.DateFromDet)
            dateFrom = new Date(($filter('date')($scope.ChequeDetailsList.DateFromDet.dateAD, 'yyyy-MM-dd')));

        if ($scope.ChequeDetailsList.DateToDet)
            dateTo = new Date(($filter('date')($scope.ChequeDetailsList.DateToDet.dateAD, 'yyyy-MM-dd')));

        $scope.DataColl = []; //declare an empty array
        $scope.gridOptions.api.setRowData($scope.DataColl);

        var beData = {
            ReportType: $scope.ChequeDetailsList.ReportType,
            DateFrom: dateFrom,
            DateTo: dateTo,
        ...
        $http({
            method: "POST",
            url: base_url + "Account/Reporting/GetAllChequeDetailsList",
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "ChequeDetailsList.xlsx");
            }

...
app.controller("BankGuarantee", function ($scope, $http,$filter, $timeout,GlobalServices) {
 ...
 $scope.GenConfig = {};
    ...
    $scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "BankGuarantee.xlsx");
            }

...
app.controller("DayBookSummaryList", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
var PrintPreviewAs = 1;
 const contextMenu = GlobalServices.createElementForMenu();
    ...
    $scope.onBtExportCSV = function () {
        var params = {
            fileName: 'DayBookSummaryList.csv',
            sheetName: 'DayBookSummaryList'
        };
 ...
 $scope.GenConfig = {};
        ...
        $timeout(function () {
            $http({
                ...
                if (comDet) {
                    $scope.DayBookSummaryList.DateFrom_TMP = new Date(comDet.StartDate);
                }
            }, function (errormessage) {
                alert('Unable to Delete data. pls try again.' + errormessage.responseText);
            });
        });
        $scope.DayBookSummaryList = {
        ...
        var columnDefs = [
            ...
            { headerName: "Particulars", width: 180, field: "Name",cellStyle:{'text-align':'right'} },
            { headerName: "DebitAmount", width: 180, field: "DrAmount",cellStyle:{'text-align':'right'} },
            { headerName: "CreditAmount", width: 180, field: "CrAmount",cellStyle:{'text-align':'right'} },
    ...
    $scope.GetDayBookSummaryList = function () {

        var dateFrom = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));
        var dateTo = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));

        if ($scope.DayBookSummaryList.DateFromDet)
            dateFrom = new Date(($filter('date')($scope.DayBookSummaryList.DateFromDet.dateAD, 'yyyy-MM-dd')));

        if ($scope.DayBookSummaryList.DateToDet)
            dateTo = new Date(($filter('date')($scope.DayBookSummaryList.DateToDet.dateAD, 'yyyy-MM-dd')));
        ...
        var beData = {
            ...
            DateFrom: dateFrom,
            DateTo: dateTo,
            VoucherType: $scope.DayBookSummaryList.VoucherType,
        };
        ...
        $http({
            method: 'POST',
            url: base_url + "Account/Reporting/GetDayBookSummaryList",
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "DayBookSummaryList.xlsx");
            }

...
app.controller("SalesmanCtrl", function ($scope, $http, $filter, $timeout, GlobalServices) {
...
$timeout(function () {
    ...
    $scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "Salesman.xlsx");
            }

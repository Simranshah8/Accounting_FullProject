...
app.controller("CancelVoucherSummary", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
 ...
 var PrintPreviewAs = 1;
  const contextMenu = GlobalServices.createElementForMenu();
    ...
    $scope.onBtExportCSV = function () {
        var params = {
            fileName: 'CancelVoucherSummary.csv',
            sheetName: 'CancelVoucherSummary'
        };
    ...
    $scope.GenConfig = {};
        ...
        $timeout(function () {
            $http({
                ...
                if (comDet) {
                    $scope.CancelVoucherSummary.DateFrom_TMP = new Date(comDet.StartDate);
                }
            }, function (errormessage) {
                alert('Unable to Delete data. pls try again.' + errormessage.responseText);
            });
        });
        $scope.CancelVoucherSummary = {
        ...
        $scope.columnDefs = [
            {
                headerName: "Date(A.D.)", width: 150, field: "VoucherDate", dataType: 'DateTime', pinned: 'left', cellRenderer: 'agGroupCellRenderer',
            ...
            {
                headerName: "Date(B.S.)", width: 150, field: "VoucherDateBS", dataType: 'DateTime', pinned: 'left', cellRenderer: 'agGroupCellRenderer',
            ...
            { headerName: "Particulars", width: 250, field: "VoucherName", dataType: 'Text',cellStyle:{'text-align':'left'} },
            ...
            { headerName: "RefNo", width: 180, field: "RefNumber", dataType: 'Text',cellStyle:{'text-align':'center'} },
            ...
            { headerName: "CancelBy", width: 180, field: "CancelBy", dataType: 'Text',cellStyle:{'text-align':'left'} },
            { headerName: "CancelDateTime", width: 250, field: "CancelDateTime", dataType: 'DateTime',cellStyle:{'text-align':'center'} },
            { headerName: "Remarks", width: 200, field: "Remarks", dataType: 'Text',cellStyle:{'text-align':'left'} },

            {
                headerName: "Action", width: 130, cellRenderer:
                    function (params) {
...
$timeout(function () {
    ...
    $scope.GetCancelVoucherSummary = function () {

        var dateFrom = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));
        var dateTo = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));

        if ($scope.CancelVoucherSummary.DateFromDet)
            dateFrom = new Date(($filter('date')($scope.CancelVoucherSummary.DateFromDet.dateAD, 'yyyy-MM-dd')));

        if ($scope.CancelVoucherSummary.DateToDet)
            dateTo = new Date(($filter('date')($scope.CancelVoucherSummary.DateToDet.dateAD, 'yyyy-MM-dd')));
        ...
        $http({
            method: "post",
            url: base_url + "Account/Reporting/GetCancelVoucherSummary",
                                        ...
                                        app.controller("CancelVoucherSummary", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
                                            ...
                                            function LoadData() {
                                                ...
                                                var columnDefs = [
                                                    ...
                                                    { headerName: "Particulars", width: 180, field: "VoucherName" },
                                                    { headerName: "VoucherType", width: 180, field: "VoucherType" },
                                                    { headerName: "VoucherNo", width: 180, field: "VoucherNo" },
                                                    { headerName: "RefNo", width: 180, field: "RefNumber" },
                                                    { headerName: "CrAmount", width: 180, field: "CrAmount" },
                                                    { headerName: "DrAmount", width: 180, field: "DrAmount" },
                                                    { headerName: "CostClass", width: 180, field: "CostClassName" },
                                                    { headerName: "User", width: 180, field: "CreateBy" },
                                                    { headerName: "CancelBy", width: 180, field: "CancelBy" },
                                                    { headerName: "CancelDateTime", width: 250, field: "CancelDateTime" },
                                                    { headerName: "Remarks", width: 180, field: "Remarks" },
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "CancelVoucherSummary.xlsx");
            }

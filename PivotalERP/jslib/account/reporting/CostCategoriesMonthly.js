...
app.controller("CostCategoriesMonthlyController", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
 var PrintPreviewAs = 1;
  const contextMenu = GlobalServices.createElementForMenu();
    ...
    $scope.onBtExportCSV = function () {
        var params = {
            fileName: 'CostCategoriesMonthly.csv',


            sheetName: 'CostCategoriesMonthly'
        };
    ...
    function LoadData() {
        ...
        $scope.columnDefs = [
            { headerName: "Particulars", width: 250, field: "MonthName", dataType: 'Text', cellStyle: { 'text-align': 'left' } },
...
$timeout(function () {
    ...
    $scope.GetCostCategoriesMonthly = function () {
        ...
        var beData = {
            CostCategoriesId: $scope.CostCategoriesMonthly.CostCategoriesId,
            //DateFrom: dateFrom,
            //DateTo: dateTo,
        };
        ...
        $http({
            method: "POST",
            url: base_url + "Account/Reporting/GetAllCostCategoriesMonthlySummary",
   ...
   $scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "CostCategoriesMonthly.xlsx");
            }

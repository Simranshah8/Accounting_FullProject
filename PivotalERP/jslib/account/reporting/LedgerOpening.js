...
app.controller("LedgerOpening", function ($scope, $http,$filter, $timeout,GlobalServices) {
...
var PrintPreviewAs = 1;
 ...
 $scope.GenConfig = {};
        ...
        $scope.columnDefs = [
            ...
            { headerName: "Date", field: "ApplicableFrom", filter: 'agDateColumnFilter', width: 120, dataType: 'DateTime', cellStyle: { 'text-align': 'center' }, valueFormatter: function (params) { return DateFormatAD(params.value); }, },
            { headerName: "Miti", field: "ApplicableMiti", filter: 'agTextColumnFilter', width: 120, dataType: 'DateTime', cellStyle: { 'text-align': 'center' } },

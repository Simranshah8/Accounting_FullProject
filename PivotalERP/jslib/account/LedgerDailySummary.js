...
app.controller("LedgerDailySummary", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
    ...
    function LoadData() {
        ...
        var columnDefs = [
            {
                headerName: "Date(A.D.)", width: 140, field: "VoucherDate_AD", cellRenderer: 'agGroupCellRenderer',
            ...
            {
                headerName: "Date(B.S.)", width: 140, field: "VoucherDate_BS", cellRenderer: 'agGroupCellRenderer',
            ...
            { headerName: "VoucherName", width: 180, field: "VoucherType" },
            { headerName: "InvoiceNo", width: 180, field: "InvoiceAmount" },
            { headerName: "ProductDescription", width: 180, field: "ProductDescription" },
            { headerName: "PanVat", width: 180, field: "PanVat" },
            { headerName: "TaxablePurchase", width: 180, field: "TaxablePurchase" },
            { headerName: "NonTaxablePurchase", width: 180, field: "NonTaxablePurchase" },
            { headerName: "ImportPurchase", width: 180, field: "ImportPurchase" },
            { headerName: "ImportVat", width: 180, field: "ImportVat" },
            { headerName: "CapitalPurchase", width: 180, field: "CapitalPurchase" },
            { headerName: "Vat", width: 180, field: "VatRate" },
    ...
    $scope.GetLedgerDailySummary = function () {
        ...
        var beData = {
            ...
            BranchIdColl: $scope.LedgerDailySummary.BranchIdColl,
            DateFrom: dateFrom,
            DateTo: dateTo,

app.controller('PurchaseQuotationController', function ($scope, $http, $timeout, $filter, $compile, GlobalServices, $document) {
    ...
    function LoadData() {
		...
		$scope.VoucherSearchOptions = [{ text: 'PartyName', value: 'ADS.Suppliers', searchType: 'text' }, { text: 'PanVat', value: 'ADS.SalesTaxNo', searchType: 'text' }, { text: 'PartyLedger', value: 'Led.Name', searchType: 'text' }, { text: 'RefNo', value: 'TS.[QuotationNo]', searchType: 'text' }, { text: 'Invoice No.', value: 'TS.AutoManualNo', searchType: 'text' }, { text: 'Voucher', value: 'V.VoucherName', searchType: 'text' }, { text: 'CostClass', value: 'CC.Name', searchType: 'text' }, { text: 'VoucherDate', value: 'TS.VoucherDate', searchType: 'date' }, { text: 'Amount', value: 'TS.TotalAmount', searchType: 'number' }];
 ...
 $scope.EPDet = {};
  ...
  itemDet.ProductName = itemDet.productDetail.Name;
        ...
        if (partyDet.PartyLedgerId && partyDet.PartyLedgerId > 0) {
            if (partyDet.PartyLedger) {
                ...
                if ($scope.lastPartyLedgerId != partyDet.PartyLedgerId && isModify == false) {
                    partyDet.PurchaseQuotationDetail = {};
                    $scope.lastPartyLedgerId = partyDet.PartyLedgerId;
                }

                if (partyDet.PurchaseQuotationDetail) {

                    if (isModify == false)
                    partyDet.PurchaseQuotationDetail.TermsOfPayment = partyDet.PartyLedger.PaymentType;

                    if (!partyDet.PurchaseQuotationDetail.Suppliers)
                        partyDet.PurchaseQuotationDetail.Suppliers = partyDet.PartyLedger.Name;

                    if (!partyDet.PurchaseQuotationDetail.Address)
                        partyDet.PurchaseQuotationDetail.Address = partyDet.PartyLedger.Address;

                    if (!partyDet.PurchaseQuotationDetail.SalesTaxNo)
                        partyDet.PurchaseQuotationDetail.SalesTaxNo = partyDet.PartyLedger.PanVat;

                    if (!partyDet.PurchaseQuotationDetail.PhoneNo)
                        partyDet.PurchaseQuotationDetail.PhoneNo = partyDet.PartyLedger.MobileNo1;
                }
            }

            if ($scope.SelectedVoucher.ActivePartyDetails == true)
                $('#frmPurchaseQuotationDetailsModel').modal('show');
            ...
            $('#frmPurchaseQuotationDetailsModel').modal('hide');
        }
            ...
            $http({
                ...
                if (res1.data.IsSuccess && res1.data.Data) {
                    ...
                    if (refVType == 1) {
                        ...
                        $scope.beData.PurchaseQuotationDetail.Description = tmpdata.RefNo;

                        $scope.beData.PurchaseQuotationDetail.Goods = tmpdata.DeliveryNoteDetail.RegdNo;

                        $scope.beData.PurchaseQuotationDetail.Suppliers = tmpdata.DeliveryNoteDetail.Buyes;
                        $scope.beData.PurchaseQuotationDetail.Address = tmpdata.DeliveryNoteDetail.Address;
                        $scope.beData.PurchaseQuotationDetail.PhoneNo = tmpdata.DeliveryNoteDetail.PhoneNo;
                        $scope.beData.PurchaseQuotationDetailSalesTaxNo = tmpdata.DeliveryNoteDetail.SalesTaxNo;

                        $scope.beData.PurchaseQuotationDetail.DriverName = tmpdata.DeliveryNoteDetail.DriverName;
                        $scope.beData.PurchaseQuotationDetail.DriverContactNo = tmpdata.DeliveryNoteDetail.DriverContactNo;
                    }
                    else if (refVType == 4) {
                        $scope.beData.PurchaseQuotationDetail.Suppliers = tmpdata.Buyes;
                        $scope.beData.PurchaseQuotationDetail.Address = tmpdata.Address;
                        $scope.beData.PurchaseQuotationDetail.PhoneNo = tmpdata.PhoneNo;
                        $scope.beData.PurchaseQuotationDetail.SalesTaxNo = tmpdata.SalesTaxNo;
                        $scope.beData.PurchaseQuotationDetail.CreditDays = tmpdata.CreditDays;
                        $scope.beData.PurchaseQuotationDetail.Description = tmpdata.Description;

                        $scope.beData.PurchaseQuotationDetail.OwnerName = tmpdata.OwnerName;
                        $scope.beData.PurchaseQuotationDetail.OwnerContactNo = tmpdata.OwnerContactNo;
                        $scope.beData.PurchaseQuotationDetail.DriverName = tmpdata.DriverName;
                        $scope.beData.PurchaseQuotationDetail.DriverContactNo = tmpdata.DriverContactNo;
                        $scope.beData.PurchaseQuotationDetail.DriverAddress = tmpdata.DriverAddress;
                        $scope.beData.PurchaseQuotationDetail.LicenseNo = tmpdata.LicenseNo;

                        $scope.beData.PurchaseQuotationDetail.Goods = tmpdata.Goods;
                        $scope.beData.PurchaseQuotationDetail.Quantity = tmpdata.Quantity;

                        $scope.beData.PurchaseQuotationDetail.TotalWT = tmpdata.TotalWT;
                        $scope.beData.PurchaseQuotationDetail.FreightRate = tmpdata.FreightRate;
                        $scope.beData.PurchaseQuotationDetail.AdvancePayment = tmpdata.AdvancePayment;

                        $scope.beData.PurchaseQuotationDetail.OtherRefereces = tmpdata.OtherRefereces;
                        $scope.beData.PurchaseQuotationDetail.TermsOfPayment = tmpdata.TermsOfPayment;
                        $scope.beData.PurchaseQuotationDetail.TermsOfDelivery = tmpdata.TermsOfDelivery;
                        $scope.beData.PurchaseQuotationDetail.Destination = tmpdata.Destination;
                        $scope.beData.PurchaseQuotationDetail.DeliveryThrough = tmpdata.DeliveryThrough;
                        $scope.beData.PurchaseQuotationDetail.DeliveryDocNo = tmpdata.DeliveryDocNo;
                    }
    ...
    $scope.SavePurchaseQuotation = function () {
        ...
        if ($scope.IsValidData() == true) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $http({
                        method: 'POST',
                        url: base_url + "Inventory/Transaction/SaveUpdatePurchaseQuotation",
    ...
    $scope.GetTransactionById = function (tran) {
        $timeout(function () {
            ...
            if (tran.TranId && tran.TranId > 0) {
                ...
                $http({
                    method: 'POST',
                    url: base_url + "Inventory/Transaction/GetPurchaseQuotationById",
                    dataType: "json",
                    data: JSON.stringify(para)
                }).then(function (res) {
                    $timeout(function () {
    ...
    $scope.GetData = function () {
        ...
        var tmpSales = {
            ...
            AditionalCostColl: [],
            PurchaseQuotationDetail: $scope.beData.PurchaseQuotationDetail,
            GodownId: $scope.beData.GodownId,
            DocumentColl: $scope.beData.DocumentColl,
            ProjectId: $scope.beData.ProjectId,
        };

        if (tmpSales.PurchaseQuotationDetail) {
            if (tmpSales.PurchaseQuotationDetail.FreightRate == undefined || tmpSales.PurchaseQuotationDetail.FreightRate == null || tmpSales.PurchaseQuotationDetail.FreightRate === undefined)
                tmpSales.PurchaseQuotationDetail.FreightRate = 0;

            if (tmpSales.PurchaseQuotationDetail.AdvancePayment == undefined || tmpSales.PurchaseQuotationDetail.AdvancePayment == null || tmpSales.PurchaseQuotationDetail.AdvancePayment === undefined)
                tmpSales.PurchaseQuotationDetail.AdvancePayment = 0;

            if (tmpSales.PurchaseQuotationDetail.CreditDays == undefined || tmpSales.PurchaseQuotationDetail.CreditDays == null || tmpSales.PurchaseQuotationDetail.CreditDays === undefined)
                tmpSales.PurchaseQuotationDetail.CreditDays = 0;
        }
        ...
        angular.forEach($scope.beData.UDFFeildsColl, function (udf) {
            if (udf.FieldType == 2 || udf.FieldType == 22 || udf.FieldType == 23) {
                ...
                voucherKeyVal[udf.NameId] = udf.UDFValueDet.dateBS;
            ...
            if (itemDet.ProductId && itemDet.ProductId > 0 && itemDet.RowType == 'P') {
                ...
                angular.forEach(itemDet.UDFFeildsColl, function (udf) {
                    ...
                    if (udf.FieldType == 2 || udf.FieldType == 22 || udf.FieldType == 23) {
                        ...
                        itemKeyVal[udf.NameId] = udf.UDFValueDet.dateBS;
                    }
                    else if (udf.FieldType == 3 && udf.Source && udf.Source.length > 0) {
   ...
   //     });
        ...
        $scope.beData.PurchaseQuotationDetail = tran.PurchaseQuotationDetail;
 ...
 $timeout(function () {                      
    ...
    $document.bind('keydown', function (event) {
        if (event.ctrlKey && event.key === 's') { // Ctrl + S
            ...
            $scope.$apply($scope.SavePurchaseQuotation);
        }
        if (event.key === 'F3') { // F3
            event.preventDefault(); // Prevent browser save action

app.controller('PurchaseOrderController', function ($scope, $http, $timeout, $filter, $compile, GlobalServices, $document) {
    ...
    function LoadData() {
        ...
        //$scope.RefVoucherTypeColl = [{ id: 1, text: 'Quotation' }, { id: 2, text: 'Sauda' }, { id: 3, text: 'Material Request' }];
        $scope.RefVoucherTypeColl = [{ id: 1, text: 'Quotation' },   { id: 3, text: 'Material Request' }];
 ...
 $scope.EPDet = {};
  ...
  itemDet.ProductName = itemDet.productDetail.Name;
            ...
            if ((isModify == false || isEmptyNum(itemDet.ItemAllocationId) == 0) && (itemDet.IsImport == false || !itemDet.IsImport)) {
                itemDet.Rate = itemDet.productDetail.PurchaseRate;
        ...
        if (partyDet.PartyLedgerId && partyDet.PartyLedgerId > 0) {
            if (partyDet.PartyLedger) {
                ...
                if ($scope.lastPartyLedgerId != partyDet.PartyLedgerId && isModify == false) {
                    ...
                    partyDet.PurchaseOrderDetail = {};
                    $scope.lastPartyLedgerId = partyDet.PartyLedgerId;

                 
                        partyDet.PurchaseOrderDetail.TermsOfPayment = partyDet.PartyLedger.PaymentType;

                    if (!partyDet.PurchaseOrderDetail.Suppliers)
                        partyDet.PurchaseOrderDetail.Suppliers = partyDet.PartyLedger.Name;

                    if (!partyDet.PurchaseOrderDetail.Address)
                        partyDet.PurchaseOrderDetail.Address = partyDet.PartyLedger.Address;

                    if (!partyDet.PurchaseOrderDetail.SalesTaxNo)
                        partyDet.PurchaseOrderDetail.SalesTaxNo = partyDet.PartyLedger.PanVat;

                    if (!partyDet.PurchaseOrderDetail.PhoneNo)
                        partyDet.PurchaseOrderDetail.PhoneNo = partyDet.PartyLedger.MobileNo1;
            ...
            if ($scope.SelectedVoucher.ActivePartyDetails == true)
                $('#frmPurchaseOrderDetailsModel').modal('show');
            ...
            $('#frmPurchaseOrderDetailsModel').modal('hide');
        }
    ...
    $scope.RefVoucherChange = function (refVType) {
        ...
        var funName = "getPendingPurchaseQuotation";

        if (refVType == 1)
            funName = "getPendingPurchaseQuotation";
        else if (refVType == 2)
            funName = "getPendingPurchaseSauda";
        else if (refVType == 3)
            funName = "GetPendingIndentForPO";
        ...
        var para = "ledgerId=" + $scope.beData.PartyLedgerId + "&agentId=" + agentId + "&voucherDate=" + vDate + "&whereQry=" + where+"&branchId="+$scope.SelectedVoucher.BDId+"&voucherId="+$scope.SelectedVoucher.VoucherId;
        $http({
            method: 'GET',
    ...
    $scope.getRefVoucherPartyDetails = function (refItem) {
        ...
        $scope.RefAditionalCostColl = [];
        if ($scope.beData.RefVoucherType && refItem && refItem.IsSelected == true && $scope.beData.RefVoucherType!=3) {

            //$scope.RefVoucherTypeColl = [{ id: 1, text: 'PurchaseQuotation' }];
            var vType = 5;
            ...
            $http({
                ...
                if (res1.data.IsSuccess && res1.data.Data) {
                    ...
                    $scope.beData.PurchaseOrderDetail.TermsOfPayment = tranDet.TermsOfPayment;
                    $scope.beData.PurchaseOrderDetail.OtherRefereces = tranDet.OtherRefereces;
                    $scope.beData.PurchaseOrderDetail.OtherReferences = tranDet.OtherRefereces;
                    $scope.beData.PurchaseOrderDetail.TermsOfDelivery = tranDet.TermsOfDelivery;
                    $scope.beData.PurchaseOrderDetail.DeliveryThrough = tranDet.DeliveryThrough;
                    $scope.beData.PurchaseOrderDetail.DeliveryDocNo = tranDet.DeliveryDocNo;
                    $scope.beData.PurchaseOrderDetail.Destination = tranDet.Destination;
                    $scope.beData.PurchaseOrderDetail.SalesQuotationTermsOfPayment = tranDet.SalesQuotationTermsOfPayment;
                    $scope.beData.PurchaseOrderDetail.SalesQuotationOtherRefereces = tranDet.SalesQuotationOtherRefereces;
                    $scope.beData.PurchaseOrderDetail.SalesQuotationTermsOfDelivery = tranDet.SalesQuotationTermsOfDelivery;
                    $scope.beData.PurchaseOrderDetail.Suppliers = tranDet.Buyes;
                    $scope.beData.PurchaseOrderDetail.Address = tranDet.Address;
                    $scope.beData.PurchaseOrderDetail.SalesTaxNo = tranDet.SalesTaxNo;
                    $scope.beData.PurchaseOrderDetail.CSTNumber = tranDet.CSTNumber;
                    $scope.beData.PurchaseOrderDetail.Notes = tranDet.Notes;
                    $scope.beData.PurchaseOrderDetail.PhoneNo = tranDet.PhoneNo;
                    $scope.beData.PurchaseOrderDetail.Description = tranDet.Description;
                    $scope.beData.PurchaseOrderDetail.OwnerName = tranDet.OwnerName;
                    $scope.beData.PurchaseOrderDetail.OwnerContactNo = tranDet.OwnerContactNo;
                    $scope.beData.PurchaseOrderDetail.DriverAddress = tranDet.DriverAddress;
                    $scope.beData.PurchaseOrderDetail.DriverName = tranDet.DriverName;
                    $scope.beData.PurchaseOrderDetail.DriverContactNo = tranDet.DriverContactNo;
                    $scope.beData.PurchaseOrderDetail.LicenseNo = tranDet.LicenseNo;
                    $scope.beData.PurchaseOrderDetail.Goods = tranDet.Goods;
                    $scope.beData.PurchaseOrderDetail.Quantity = tranDet.Quantity;
                    $scope.beData.PurchaseOrderDetail.FreightRate = tranDet.FreightRate;
                    $scope.beData.PurchaseOrderDetail.AdvancePayment = tranDet.AdvancePayment;
                    $scope.beData.PurchaseOrderDetail.TotalWT = tranDet.TotalWT;
                    $scope.beData.PurchaseOrderDetail.ContactNo = tranDet.ContactNo;
                    $scope.beData.PurchaseOrderDetail.RegdNo = tranDet.RegdNo;
                    $scope.beData.PurchaseOrderDetail.EngineNo = tranDet.EngineNo;
                    $scope.beData.PurchaseOrderDetail.ChassisNo = tranDet.ChassisNo;
                    $scope.beData.PurchaseOrderDetail.Model = tranDet.Model;
                    $scope.beData.PurchaseOrderDetail.VinNo = tranDet.VinNo;
                    $scope.beData.PurchaseOrderDetail.CreditDays = tranDet.CreditDays;
                    $scope.beData.PurchaseOrderDetail.ExportCountry = tranDet.ExportCountry;
                    $scope.beData.PurchaseOrderDetail.PPNo = tranDet.PPNo;
                    $scope.beData.PurchaseOrderDetail.PPDate = tranDet.PPDate;
                    $scope.beData.PurchaseOrderDetail.OtherRefereces1 = tranDet.OtherRefereces1;
                    $scope.beData.PurchaseOrderDetail.PaymentTermsId = tranDet.PaymentTermsId;
                    $scope.beData.PurchaseOrderDetail.FreightTypeId = tranDet.FreightTypeId;
        ...
        if (filterData.length > 0) {
            ...
            angular.forEach(filterData, function (fd) {
                var refItem = {
                    ...
                    SaudaItemAllocationId: refVType == 2 ? fd.ItemAllocationId : null,
                    IndentItemAllocationId: refVType == 3 ? fd.ItemAllocationId : null,
                    RefVType: refVType,
            ...
            $timeout(function () {
                ...
                var funName = "GetPurchaseQuotationDetailsByItemAllocationId";

                if (refVType == 1)
                    funName = "GetPurchaseQuotationDetailsByItemAllocationId";
                else if (refVType == 2)
                    funName = "GetPurchaseSaudaByItemAllocationId";
                else if (refVType == 3)
                    funName = "GetIndentByItemAllocationId";
                        ...
                        if (idet.AditionalCostOnTheBasis == 0) {
                            if (idet.costLedgerDetail.LedgerType == 3) {
                                if ($scope.SelectedVoucher.Product.ProductWiseExciseDuty == true) {
                                    ...
                                    if (col == 'rate' && productExciduteAmt == 0) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $timeout(function () {
                        ...
                        $http({
                            method: 'POST',
                            url: base_url + "Inventory/Transaction/SaveUpdatePurchaseOrder",
                            headers: { 'Content-Type': undefined },
...
//                $scope.ClearData();
                ...
                $timeout(function () {
                    $http({
                        method: 'POST',
                        url: base_url + "Inventory/Transaction/GetPurchaseOrderById",
                        dataType: "json",
                        data: JSON.stringify(para)
                    }).then(function (res) {
                        $timeout(function () {
    ...
    $scope.GetData = function () {
        ...
        var tmpSales = {
            ...
            AditionalCostColl: [],
            PurchaseOrderDetail: $scope.beData.PurchaseOrderDetail,
            GodownId: $scope.beData.GodownId,
            DocumentColl: $scope.beData.DocumentColl,
            ProjectId: $scope.beData.ProjectId,
        };

        if (tmpSales.PurchaseOrderDetail) {
            if (tmpSales.PurchaseOrderDetail.FreightRate == undefined || tmpSales.PurchaseOrderDetail.FreightRate == null || tmpSales.PurchaseOrderDetail.FreightRate === undefined)
                tmpSales.PurchaseOrderDetail.FreightRate = 0;

            if (tmpSales.PurchaseOrderDetail.AdvancePayment == undefined || tmpSales.PurchaseOrderDetail.AdvancePayment == null || tmpSales.PurchaseOrderDetail.AdvancePayment === undefined)
                tmpSales.PurchaseOrderDetail.AdvancePayment = 0;

            if (tmpSales.PurchaseOrderDetail.CreditDays == undefined || tmpSales.PurchaseOrderDetail.CreditDays == null || tmpSales.PurchaseOrderDetail.CreditDays === undefined)
                tmpSales.PurchaseOrderDetail.CreditDays = 0;
        }
        ...
        angular.forEach($scope.beData.ItemDetailsColl, function (itemDet) {
            if (itemDet.ProductId && itemDet.ProductId > 0 && itemDet.RowType == 'P') {
                ...
                var itemAllocation = {
                    ...
                    SaudaItemAllocationId: itemDet.SaudaItemAllocationId,
                    IndentItemAllocationId: itemDet.IndentItemAllocationId,
                    BundleId: 0,
                    BundleQty: 0,
   ...
   //     });
        ...
        $scope.beData.PurchaseOrderDetail = tran.PurchaseOrderDetail;
      ...
      //  $scope.beData.GodownId = tran.GodownId
        ...
        angular.forEach(tran.ItemAllocationColl, function (itemA) {
            ...
            itemA.ActualQty = isEmptyAmt(itemA.ActualQty) +isEmptyAmt(itemA.FreeQty);
            ...
            angular.forEach(itemA.ItemDetailsColl, function (itemAD) {
                ...
                itemAD.SaudaItemAllocationId = itemA.SaudaItemAllocationId;
 ...
 <div class="input-group-prepend">
    ...
    $scope.getVoucherNo = function () {
        ...
        $scope.ClearItemDetails();
        $scope.beData.PurchaseOrderDetail = {};
 ...
 $timeout(function () {                      
    ...
    $scope.ChangeTermsOfPayment = function () {
        if ($scope.beData && $scope.beData.PurchaseOrderDetail) {
            if ($scope.beData.PurchaseOrderDetail.TermsOfPayment) {
                var findPM = $scope.PaymentModeColl_Qry.firstOrDefault(p1 => p1.Name == $scope.beData.PurchaseOrderDetail.TermsOfPayment);
                if (findPM) {
                    $scope.beData.PurchaseOrderDetail.TypeOfPayment = findPM.TypeOfPayment;
                    $scope.beData.PurchaseOrderDetail.PaymentTermsId = findPM.PaymentModeId;
                }
            }
        }
    }
    ...
    $document.bind('keydown', function (event) {
        if (event.ctrlKey && event.key === 's') { // Ctrl + S
            ...
            $scope.$apply($scope.SavePurchaseOrder);
        }
        if (event.key === 'F3') { // F3
            event.preventDefault(); // Prevent browser save action
    ...
    $scope.ShowProductCurrentStatus = function (itemDet,ind) {
        GlobalServices.ShowProductCurrentStatus(itemDet.ProductId, itemDet.GodownId);
    }

    $scope.MakePurchaseOrder = function () {
    ...
    $scope.ShowPendingVoucherList = function () {
        ...
        $scope.PendingVoucherColl = [];
        if ($scope.beData.RefVoucherType == 3 || $scope.beData.RefVoucherType == null || $scope.beData.RefVoucherType == undefined) {
            $scope.loadingstatus = 'running';
            showPleaseWait();
            ...
            $http({
                method: "GET",
                url: base_url + "Inventory/Transaction/GetPendingIndentForPO?" + ToQueryString(beData),

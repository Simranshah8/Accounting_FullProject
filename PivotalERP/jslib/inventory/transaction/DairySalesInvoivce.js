app.controller('DairySalesInvoiceController', function ($scope, $http, $timeout, $filter, $compile, GlobalServices, $document) {
            ...
            $http({
                ...
                if (res1.data.IsSuccess && res1.data.Data) {
                    ...
                    if (itemDet.ProductId == null) {
                        ...
                        itemDet.CanEditRate = (itemDet.productDetail.CanEditRateSales==undefined ? true :  itemDet.productDetail.CanEditRateSales);
    ...
    $scope.GetData = function () {
        ...
        angular.forEach($scope.beData.ItemDetailsColl, function (itemDet) {
            if (itemDet.ProductId && itemDet.ProductId > 0 && itemDet.RowType == 'P') {
                ...
                if (itemDet.PartyLedger && (!tmpSales.SalesInvoiceDetail.Buyes || tmpSales.SalesInvoiceDetail.Buyes.length == 0)) {
                    tmpSales.SalesInvoiceDetail.Buyes = itemDet.PartyLedger.Name;
                    tmpSales.SalesInvoiceDetail.Address = itemDet.PartyLedger.Address;
                }
                else if (tmpSales.PartyLedger && (!tmpSales.SalesInvoiceDetail.Buyes || tmpSales.SalesInvoiceDetail.Buyes.length == 0)) {
                    tmpSales.SalesInvoiceDetail.Buyes = tmpSales.PartyLedger.Name;
                    tmpSales.SalesInvoiceDetail.Address = tmpSales.PartyLedger.Address;
                }

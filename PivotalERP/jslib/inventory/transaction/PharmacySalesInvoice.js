app.controller('SalesInvoiceController', function ($scope, $http, $timeout, $filter, GlobalServices) {
    ...
    function LoadData() {
        ...
        var columnDefs = [
            ...
            { headerName: "Days", field: "Days", filter: "agTextColumnFilter", width: 120 },
            ...
            { headerName: "Amount", field: "Amount", filter: 'agNumberColumnFilter', width: 120, cellStyle: { 'text-align': 'right' }, valueFormatter: function (params) { return Numberformat(params.value); } },
    ...
    $scope.CalculateTotalAndSubTotal = function () {
        ...
        $scope.beData.SubTotal = $filter('number')(subTotal, $scope.SelectedVoucher.NoOfDecimalPlaces);
        $scope.beData.TotalAmount = $filter('number')(subTotal, $scope.SelectedVoucher.NoOfDecimalPlaces);
    };

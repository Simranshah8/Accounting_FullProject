app.controller('TeaPurchaseInvoiceController', function ($scope, $http, $timeout, $filter, $compile, GlobalServices, $document) {
	$scope.Title = 'TeaPurchaseInvoice';
    ...
    $scope.ChangeItemRowValue = function (itemDet, col) {
        ...
        if (!itemDet.productDetail) {
            if ($scope.beData.Switch == false) {
                itemDet.productDetail = $scope.beData.productDetail;
            }
        }
        ...
        if (rate == 0) {
            if (col != 'rate') {
                itemDet.Rate = itemDet.productDetail.Rate;
                rate = itemDet.Rate;
            }
        }
    ...
    $scope.GetData = function () {
        ...
        angular.forEach($scope.beData.ItemDetailsColl, function (itemDet) {
            if (itemDet.ProductId && itemDet.ProductId > 0 && itemDet.RowType == 'P') {
                var itemAllocation = {
                    ProductId: ($scope.beData.Switch==true ? newSales.TranProductId : itemDet.ProductId),
 ...
 $timeout(function () {                      
    ...
    $scope.ChangeEntryMode = function () {
        if ($scope.beData.Switch == true) {
            $scope.beData.productDetail = null;
        }
        else {

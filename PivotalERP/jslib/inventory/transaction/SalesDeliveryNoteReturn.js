app.controller('DeliveryNoteReturnController', function ($scope, $http, $timeout, $filter, $compile, GlobalServices, $document) {
  ...
  itemDet.ProductName = itemDet.productDetail.Name;
        ...
        if (partyDet.PartyLedgerId && partyDet.PartyLedgerId > 0) {
            if (partyDet.PartyLedger) {
                ...
                if ($scope.lastPartyLedgerId != partyDet.PartyLedgerId && isModify == false) {
                    partyDet.DeliveryNoteReturnDetail = {};
                    $scope.lastPartyLedgerId = partyDet.PartyLedgerId;
                }

                if (partyDet.DeliveryNoteReturnDetail) {

                    if (isModify == false)
                    partyDet.DeliveryNoteReturnDetail.TermsOfPayment = partyDet.PartyLedger.PaymentType;

                    if (!partyDet.DeliveryNoteReturnDetail.Buyes)
                        partyDet.DeliveryNoteReturnDetail.Buyes = partyDet.PartyLedger.Name;

                    if (!partyDet.DeliveryNoteReturnDetail.Address)
                        partyDet.DeliveryNoteReturnDetail.Address = partyDet.PartyLedger.Address;

                    if (!partyDet.DeliveryNoteReturnDetail.SalesTaxNo)
                        partyDet.DeliveryNoteReturnDetail.SalesTaxNo = partyDet.PartyLedger.PanVat;

                    if (!partyDet.DeliveryNoteReturnDetail.PhoneNo)
                        partyDet.DeliveryNoteReturnDetail.PhoneNo = partyDet.PartyLedger.MobileNo1;
                }
            }

            if ($scope.SelectedVoucher.ActivePartyDetails == true)
                $('#frmDeliveryNoteReturnDetailsModel').modal('show');
            ...
            $scope.RecalculateAdditioncalCost();
            $scope.CalculateTotalAndSubTotal();
            $('#frmDeliveryNoteReturnDetailsModel').modal('hide');
        }
            ...
            $http({
                ...
                if (res1.data.IsSuccess && res1.data.Data) {
                    ...
                    $timeout(function () {
                        ...
                        $scope.beData.DeliveryNoteReturnDetail.TermsOfPayment = tranDet.TermsOfPayment;
                        $scope.beData.DeliveryNoteReturnDetail.OtherRefereces = tranDet.OtherRefereces;
                        $scope.beData.DeliveryNoteReturnDetail.TermsOfDelivery = tranDet.TermsOfDelivery;
                        $scope.beData.DeliveryNoteReturnDetail.DeliveryThrough = tranDet.DeliveryThrough;
                        $scope.beData.DeliveryNoteReturnDetail.DeliveryDocNo = tranDet.DeliveryDocNo;
                        $scope.beData.DeliveryNoteReturnDetail.Destination = tranDet.Destination;
                        $scope.beData.DeliveryNoteReturnDetail.SalesQuotationTermsOfPayment = tranDet.SalesQuotationTermsOfPayment;
                        $scope.beData.DeliveryNoteReturnDetail.SalesQuotationOtherRefereces = tranDet.SalesQuotationOtherRefereces;
                        $scope.beData.DeliveryNoteReturnDetail.SalesQuotationTermsOfDelivery = tranDet.SalesQuotationTermsOfDelivery;
                        $scope.beData.DeliveryNoteReturnDetail.Buyes = tranDet.Buyes;
                        $scope.beData.DeliveryNoteReturnDetail.Address = tranDet.Address;
                        $scope.beData.DeliveryNoteReturnDetail.SalesTaxNo = tranDet.SalesTaxNo;
                        $scope.beData.DeliveryNoteReturnDetail.CSTNumber = tranDet.CSTNumber;
                        $scope.beData.DeliveryNoteReturnDetail.Notes = tranDet.Notes;
                        $scope.beData.DeliveryNoteReturnDetail.PhoneNo = tranDet.PhoneNo;
                        $scope.beData.DeliveryNoteReturnDetail.Description = tranDet.Description;
                        $scope.beData.DeliveryNoteReturnDetail.OwnerName = tranDet.OwnerName;
                        $scope.beData.DeliveryNoteReturnDetail.OwnerContactNo = tranDet.OwnerContactNo;
                        $scope.beData.DeliveryNoteReturnDetail.DriverAddress = tranDet.DriverAddress;
                        $scope.beData.DeliveryNoteReturnDetail.DriverName = tranDet.DriverName;
                        $scope.beData.DeliveryNoteReturnDetail.DriverContactNo = tranDet.DriverContactNo;
                        $scope.beData.DeliveryNoteReturnDetail.LicenseNo = tranDet.LicenseNo;
                        $scope.beData.DeliveryNoteReturnDetail.Goods = tranDet.Goods;
                        $scope.beData.DeliveryNoteReturnDetail.Quantity = tranDet.Quantity;
                        $scope.beData.DeliveryNoteReturnDetail.FreightRate = tranDet.FreightRate;
                        $scope.beData.DeliveryNoteReturnDetail.AdvancePayment = tranDet.AdvancePayment;
                        $scope.beData.DeliveryNoteReturnDetail.TotalWT = tranDet.TotalWT;
                        $scope.beData.DeliveryNoteReturnDetail.ContactNo = tranDet.ContactNo;
                        $scope.beData.DeliveryNoteReturnDetail.RegdNo = tranDet.RegdNo;
                        $scope.beData.DeliveryNoteReturnDetail.EngineNo = tranDet.EngineNo;
                        $scope.beData.DeliveryNoteReturnDetail.ChassisNo = tranDet.ChassisNo;
                        $scope.beData.DeliveryNoteReturnDetail.Model = tranDet.Model;
                        $scope.beData.DeliveryNoteReturnDetail.VinNo = tranDet.VinNo;

                        if (tranDet.CreditDays > 0)
                            $scope.beData.DeliveryNoteReturnDetail.CreditDays = tranDet.CreditDays;

                        $scope.beData.DeliveryNoteReturnDetail.ExportCountry = tranDet.ExportCountry;
                        $scope.beData.DeliveryNoteReturnDetail.PPNo = tranDet.PPNo;
                        $scope.beData.DeliveryNoteReturnDetail.PPDate = tranDet.PPDate;
                        $scope.beData.DeliveryNoteReturnDetail.OtherRefereces1 = tranDet.OtherRefereces1;
                        $scope.beData.DeliveryNoteReturnDetail.PaymentTermsId = tranDet.PaymentTermsId;
                        $scope.beData.DeliveryNoteReturnDetail.FreightTypeId = tranDet.FreightTypeId;
                        $scope.beData.Narration = tranData.Narration;
                        $scope.beData.No = tranData.RefNo;
                        $scope.beData.RefNo = tranData.RefNo;

                        $scope.beData.DeliveryNoteReturnDetail.BillToId = tranDet.BillToId;
                        $scope.beData.DeliveryNoteReturnDetail.ShipToId = tranDet.ShipToId;
                        $scope.beData.DeliveryNoteReturnDetail.BillToAddress = tranDet.BillToAddress;
                        $scope.beData.DeliveryNoteReturnDetail.ShipToAddress = tranDet.ShipToAddress;
    ...
    $scope.SaveDeliveryNoteReturn = function () {
        ...
        if ($scope.IsValidData() == true) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $http({
                        method: 'POST',
                        url: base_url + "Inventory/Transaction/SaveSalesDeliveryNoteReturn",
                        headers: { 'Content-Type': undefined },
    ...
    $scope.GetTransactionById = function (tran) {
        $timeout(function () {
            ...
            if (tran.TranId && tran.TranId > 0) {
                ...
                $http({
                    method: 'POST',
                    url: base_url + "Inventory/Transaction/GetDeliveryNoteReturnById",
                    dataType: "json",
                    data: JSON.stringify(para)
                }).then(function (res) {
                    $timeout(function () {
    ...
    $scope.GetData = function () {
        ...
        var tmpSales = {
            ...
            AditionalCostColl: [],
            DeliveryNoteReturnDetail: $scope.beData.DeliveryNoteReturnDetail,
            GodownId: $scope.beData.GodownId,
 ...
 $timeout(function () {                      
    ...
    $document.bind('keydown', function (event) {
        if (event.ctrlKey && event.key === 's') { // Ctrl + S
            ...
            $scope.$apply($scope.SaveDeliveryNoteReturn);
        }
        if (event.key === 'F3') { // F3
            event.preventDefault(); // Prevent browser save action

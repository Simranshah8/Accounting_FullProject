...
app.controller("deliveryAnalysisController", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
  ...
  var PrintPreviewAs = 1;
    ...
    function LoadData() {
        ...
        var columnDefs = [
            ...
            { headerName: "Delivery Qty.", width: 160, field: "OutQty", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, datatype: 'double' },
            { headerName: "Delivery Amt.", width: 160, field: "OutAmt", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, datatype: 'double' },
            ...
            { headerName: "Delivery Ledger", width: 120, field: "SalesLedger", cellStyle: { 'text-align': 'left' }, datatype: 'string' },
    ...
    $scope.GetProductGroupSummary = function () {
        ...
        $http({
            method: "POST",
            url: base_url + "Inventory/Reporting/GetDeliveryAnalysis",
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "deliveryAnalysis.xlsx");
            }

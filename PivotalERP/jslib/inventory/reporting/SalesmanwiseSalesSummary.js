...
app.controller("SalesmanwiseSalesSummary", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
  ...
  var PrintPreviewAs = 1;
    ...
    $scope.onBtExportCSV = function () {
        var params = {
            fileName: 'SalesmanwiseSalesSummary.csv',
            sheetName: 'SalesmanwiseSalesSummary'
        };
    ...
    function LoadData() {
        ...
        $scope.SalesmanwiseSalesSummary = {
        ...
        $scope.columnDefs = [
            ...
            { headerName: "Al.Qty.1", width: 140, field: "AlQty1", dataType: 'Number', cellStyle: { 'text-align': 'left' } },
            { headerName: "Al.Qty.2", width: 140, field: "AlQty2", dataType: 'Number', cellStyle: { 'text-align': 'left' } },
 ...
 $timeout(function () {
    ...
    $scope.GetSalesmanwiseSalesSummary = function () {
        $scope.ClearData();
        var dateFrom = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));
        var dateTo = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));

        if ($scope.SalesmanwiseSalesSummary.DateFromDet)
            dateFrom = new Date(($filter('date')($scope.SalesmanwiseSalesSummary.DateFromDet.dateAD, 'yyyy-MM-dd')));

        if ($scope.SalesmanwiseSalesSummary.DateToDet)
            dateTo = new Date(($filter('date')($scope.SalesmanwiseSalesSummary.DateToDet.dateAD, 'yyyy-MM-dd')));
        ...
        var beData = {
            DateFrom: dateFrom,
            DateTo: dateTo,
            VoucherType: $scope.SalesmanwiseSalesSummary.VoucherId,
            isPost: $scope.SalesmanwiseSalesSummary.IsPost,
            branchId: $scope.SalesmanwiseSalesSummary.BranchId
        };
        ...
        $http({
            method: "POST",
            url: base_url + "Inventory/Reporting/GetSalesmanwiseSalesSummary",
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "SalesmanwiseSalesSummary.xlsx");
            }

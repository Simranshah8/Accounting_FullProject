...
app.controller("PendingIndentDet", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
  ...
  var PrintPreviewAs = 1;
    ...
    function LoadData() {
        ...
        $scope.columnDefs = [
            ...
            { headerName: "Requester", width: 200, field: "RequesterName", cellStyle: { 'text-align': 'left' }, dataType: 'Text' },
            { headerName: "Branch", width: 200, field: "Branch", dataType: 'Text', cellStyle: { 'text-align': 'left' } },
            { headerName: "MR No.", width: 120, field: "VoucherNo", dataType: 'Number', cellStyle: { 'text-align': 'right' } },
            { headerName: "MR Qty", width: 130, field: "IndentQty", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },

            {
                headerName: "MR Qty1", width: 130, field: "IndentQty1", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter",
                valueFormatter: function (params)
                {
                    if (params.value > 0) {
                        var unit = params.data.Unit1;
                        return Numberformat(params.value) + ' ' + (unit ? unit : '');
                    } else {
                        return "";
                    }
            ...
            {
                headerName: "MR Qty2", width: 130, field: "IndentQty2", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter",
                valueFormatter: function (params) {

                    if (params.value > 0) {
                        var unit = params.data.Unit2;
                        return Numberformat(params.value) + ' ' + (unit ? unit : '');
                    } else {
                        return "";
                    }
            ...
            { headerName: "PO Qty", width: 130, field: "POOrder", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "SO Qty", width: 130, field: "SOOrder", dataType: 'Number', cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            ...
            { headerName: "P.Group1", width: 200, field: "ProductGroup1", dataType: 'Text', cellStyle: { 'text-align': 'left' } },
            { headerName: "P.Group2", width: 200, field: "ProductGroup2", dataType: 'Text', cellStyle: { 'text-align': 'left' } },
            ...
            { headerName: "Narration", width: 150, field: "ItemNarration", dataType: 'Text', cellStyle: { 'text-align': 'left' } },
    ...
    $scope.GetPendingPurchaseOrder = function () {
        ...
        var beData = {
            ...
            branchId:null,
            branchIdColl: $scope.PendingPurchaseOrder.BranchId,
            productGroupIdColl: ($scope.PendingPurchaseOrder.ProductGroupId ? $scope.PendingPurchaseOrder.ProductGroupId.toString() : '')
        };
        ...
        $http({
            method: "post",
            url: base_url + "Inventory/Reporting/GetPendingIndent",

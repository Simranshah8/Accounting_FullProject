...
app.controller("receiptNoteAnalysisController", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
  ...
  var PrintPreviewAs = 1;
    ...
    $scope.onBtExportCSV = function () {
        var params = {
            fileName: 'ReceiptNote.csv',
            sheetName: 'ReceiptNote'
        };
    ...
    function LoadData() {
        ...
        var columnDefs = [
            ...
            { headerName: "ReceiptNote Qty.", width: 160, field: "OutQty", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, datatype: 'double' },
            { headerName: "ReceiptNote Amt.", width: 160, field: "OutAmt", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, datatype: 'double' },
            ...
            { headerName: "ReceiptNote Ledger", width: 120, field: "SalesLedger", cellStyle: { 'text-align': 'left' }, datatype: 'string' },
        ];
 ...
 $timeout(function () {
    ...
    $scope.GetProductGroupSummary = function () {
        ...
        $http({
            method: "POST",
            url: base_url + "Inventory/Reporting/GetReceiptNoteAnalysis",
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "receiptNoteAnalysis.xlsx");
            }

...
app.controller("ProductGroupSummaryAsList", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
  ...
  var PrintPreviewAs = 1;
    ...
    $scope.onBtExportCSV = function () {
        var params = {
            fileName: 'ProductGroupSummaryAsList.csv',
            sheetName: 'ProductGroupSummaryAsList'
        };
    ...
    function LoadData() {
        ...
        $scope.ProductGroupSummaryAsList = {
        ...
        var columnDefs = [
            ...
            { headerName: "GodownName", width: 180, field: "GodownName", cellStyle: { 'text-align': 'left' }  },
            { headerName: "Brand", width: 180, field: "ProductBrand", cellStyle: { 'text-align': 'left' }  },
            { headerName: "Categories", width: 180, field: "ProductCategoriesName", cellStyle: { 'text-align': 'left' }  },
            ...
            { headerName: "AUName1", width: 180, field: "AUName1", cellStyle: { 'text-align': 'right' }  },
            { headerName: "AUName2", width: 180, field: "AUName2", cellStyle: { 'text-align': 'right' }  },
            { headerName: "AUName3", width: 180, field: "AUName3", cellStyle: { 'text-align': 'right' }  },
            ...
            { headerName: "PurchaseLedger", width: 180, field: "PurchaseLedger", cellStyle: { 'text-align': 'left' }  },
    ...
    $scope.GetProductGroupSummaryAsList = function () {
        $scope.ClearData();
        var dateFrom = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));
        var dateTo = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));

        if ($scope.ProductGroupSummaryAsList.DateFromDet)
            dateFrom = new Date(($filter('date')($scope.ProductGroupSummaryAsList.DateFromDet.dateAD, 'yyyy-MM-dd')));

        if ($scope.ProductGroupSummaryAsList.DateToDet)
            dateTo = new Date(($filter('date')($scope.ProductGroupSummaryAsList.DateToDet.dateAD, 'yyyy-MM-dd')));
        ...
        var beData = {
            DateFrom: dateFrom,
            DateTo: dateTo,
            VoucherType: $scope.ProductGroupSummaryAsList.VoucherId,
            isPost: $scope.ProductGroupSummaryAsList.IsPost,
            ledgergroupid: $scope.ProductGroupSummaryAsList.LedgerGroupId,
            isClearOnly: $scope.ProductGroupSummaryAsList.IsClearOnly,
            branchId: $scope.ProductGroupSummaryAsList.BranchId,
            ProductGroupId: 0,
            GodownId: 0,
        };
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "ProductGroupSummaryAsList.xlsx");
            }

...
app.controller("purchaseAnalysisController", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
  ...
  var PrintPreviewAs = 1;
    ...
    function LoadData() {
        ...
        $scope.columnDefs = [
            ...
            { headerName: "Actual Purchase Qty.", width: 160, field: "Qty", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, datatype: 'double' },
            { headerName: "Actual Purchase Amt.", width: 160, field: "Amt", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, datatype: 'double' },
            { headerName: "Purchase Qty.", width: 160, field: "InQty", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, datatype: 'double' },
            { headerName: "Purchase Amt.", width: 160, field: "InAmt", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, datatype: 'double' },
            { headerName: "Return Qty.", width: 160, field: "OutQty", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, datatype: 'double' },
            { headerName: "Return Amt.", width: 160, field: "OutAmt", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, datatype: 'double' },
            ...
            { headerName: "Purchase Ledger", width: 120, field: "SalesLedger", cellStyle: { 'text-align': 'left' }, datatype: 'string' },
        ];
    ...
    $scope.GetProductGroupSummary = function () {
        ...
        $http({
            method: "POST",
            url: base_url + "Inventory/Reporting/GetPurchaseAnalysis",
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "purchaseAnalysis.xlsx");
            }

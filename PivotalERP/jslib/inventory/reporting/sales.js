...
app.controller('pendingSOSummaryCtrl', function ($scope, $http, $filter, $timeout,GlobalServices, companyDet) {
    ...
    function LoadData() {
        ...
        var columnDefs = [
            ...
            { headerName: "Unit", field: "BaseUnit", filter: 'agTextColumnFilter', width: 140, cellStyle: { 'text-align': 'left' }  }
        ];
 ...
 $timeout(function () {
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "Sales.xlsx");
            }

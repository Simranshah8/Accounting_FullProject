...
app.controller("MultipleProductVoucher", function ($scope, $http, $filter, $timeout, GlobalServices, $compile) {
  ...
  var PrintPreviewAs = 1;
    ...
    $scope.onBtExportCSV = function () {
        var params = {
            fileName: 'MultipleProductVoucher.csv',
            sheetName: 'MultipleProductVoucher'
        };
    ...
    function LoadData() {
        ...
        $scope.columnDefs = [
            {
                headerName: "Date(A.D.)", dataType: 'DateTime', width: 120, pinned: 'left', field: "VoucherDateAD", cellRenderer: 'agGroupCellRenderer',
            ...
            {
                headerName: "Miti", dataType: 'DateTime', pinned: 'left', width: 120, field: "VoucherDateBS", cellRenderer: 'agGroupCellRenderer',
            ...
            { headerName: "Particulars", dataType: 'Text', pinned: 'left', width: 180, field: "Name", cellStyle: { 'text-align': 'left' }  },
            { headerName: "VoucherType", dataType: 'Text', width: 180, field: "VoucherType", cellStyle: { 'text-align': 'left' }  },
            { headerName: "VoucherNo", dataType: 'Number', width: 180, field: "VoucherNo", cellStyle: { 'text-align': 'center' }  },
            { headerName: "RefNo", dataType: 'Number', width: 180, field: "RefNo", cellStyle: { 'text-align': 'center' }  },
            { headerName: "InRate", width: 140, dataType: 'Number', field: "InRate", cellStyle: { 'text-align': 'right' }  },
            { headerName: "InAmt", width: 140, dataType: 'Number', field: "InAmt", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "InQty", width: 140, dataType: 'Number', field: "InQty", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "OutRate", width: 140, dataType: 'Number', field: "OutRate", cellStyle: { 'text-align': 'right' }  },
            { headerName: "OutQty", width: 140, dataType: 'Number',  field: "OutQty", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "OutAmt", width: 140, dataType: 'Number',  field: "OutAmt", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "BalanceQty", width: 140, dataType: 'Number',  field: "BalanceQty", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "BalanceAmt", width: 140, dataType: 'Number',  field: "BalanceAmount", cellStyle: { 'text-align': 'right' }, filter: "agNumberColumnFilter", valueFormatter: function (params) { return Numberformat(params.value); }, },
            { headerName: "Unit", width: 140, field: "Unit", dataType: 'Text',  cellStyle: { 'text-align': 'left' }  },
            { headerName: "BalanceRate", width: 140, dataType: 'Number',  field: "BalanceRate", cellStyle: { 'text-align': 'right' }  },
            { headerName: "ItemNarration", width: 180, dataType: 'Text',  field: "ItemNarration", cellStyle: { 'text-align': 'left' }  },
            { headerName: "CommonNarration", width: 180, dataType: 'Text',  field: "Narration", cellStyle: { 'text-align': 'left' }  },
        ...
        $scope.gridOptions = {
            ...
            onFilterChanged: function () {
                ...
                $scope.gridOptions.api.forEachNodeAfterFilterAndSort(function (node) {
                    ...
                    dt.BalanceAmount += fData.BalanceAmount;                  
    ...
    $scope.GetMultipleProductVoucher = function () {
        $scope.ClearData();
        var dateFrom = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));
        var dateTo = new Date(($filter('date')(new Date(), 'yyyy-MM-dd')));

        if ($scope.MultipleProductVoucher.DateFromDet)
            dateFrom = new Date(($filter('date')($scope.MultipleProductVoucher.DateFromDet.dateAD, 'yyyy-MM-dd')));

        if ($scope.MultipleProductVoucher.DateToDet)
            dateTo = new Date(($filter('date')($scope.MultipleProductVoucher.DateToDet.dateAD, 'yyyy-MM-dd')));

        $scope.DataColl = []; //declare an empty array
        $scope.gridOptions.api.setRowData($scope.DataColl);

        var beData = {
            ProductIdColl: $scope.MultipleProductVoucher.ProductIdColl,
            GodownIdColl: $scope.MultipleProductVoucher.GodownIdColl,
            DateFrom: dateFrom,
            DateTo: dateTo,
        ...
        $http({
            method: "POST",
            url: base_url + "Inventory/Reporting/GetMultipleProductVoucher",
            ...
            if (res.data.IsSuccess && res.data.Data) {
                ...
                angular.forEach($scope.DataColl, function (dc) {
                    if (dc.BalanceAmount == 1 || dc.BalanceAmount == 'DR')
                        Opening += dc.BalanceAmount;
                    else
                        Opening -= dc.BalanceAmount;
                });
                ...
                $scope.dataForBottomGrid[0].BalanceAmount = Opening;
...
$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "MultipleProductVoucher.xlsx");
            }

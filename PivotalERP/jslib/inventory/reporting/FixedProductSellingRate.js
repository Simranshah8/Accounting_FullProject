...
app.controller("fixedProductRateCtrl", function ($scope, $http, $filter, $timeout,GlobalServices) {
    $scope.Title = 'Product';
  ...
  var PrintPreviewAs = 1;
    ...
    function LoadData() {
        ...
        $scope.columnDefs = [
            ...
            { headerName: "EngineNo", field: "EngineNo", dataType: 'Text', filter: "agTextColumnFilter", pinned: 'left', width: 300,  cellStyle: { 'text-align': 'left' } },
            { headerName: "Model", field: "Model", dataType: 'Text', filter: "agTextColumnFilter", width: 200,  cellStyle: { 'text-align': 'left' } },
            
            { headerName: "Name", field: "Name", filter: "agTextColumnFilter", dataType: 'Text', width: 200,  cellStyle: { 'text-align': 'left' } },
            { headerName: "Code", field: "Code", filter: "agTextColumnFilter", dataType: 'Number', width: 110,  cellStyle: { 'text-align': 'left' } },
            { headerName: "Applicable Date", field: "ApplicableFromAD", dataType: 'DateTime', filter: "agDateColumnFilter", width: 180,  cellStyle: { 'text-align': 'center' } },
            { headerName: "Applicable Miti", field: "ApplicableFromBS", dataType: 'DateTime', filter: "agTextColumnFilter", width: 180,  cellStyle: { 'text-align': 'center' } },            
            { headerName: "SalesRate", field: "Rate", dataType: 'Number', filter: 'agNumberColumnFilter', width: 150, cellStyle: { 'text-align': 'right' } },            
            { headerName: "LogDateTime", field: "LogDateTime", dataType: 'DateTime', filter: 'agDateColumnFilter', width: 180, cellStyle: { 'text-align': 'left' } },            
            { headerName: "UpdateBy", field: "UserName", dataType: 'Text', filter: 'agTextColumnFilter', width: 180, cellStyle: { 'text-align': 'left' } },
    ...
    $scope.GetAllProduct = function () {
        ...
        $http({
            method: 'GET',
            url: base_url + "Inventory/Reporting/GetFixedProductSellingRate",
            dataType: "json"
	...
	$scope.DownloadAsXls = function () {
        ...
        $http({
            ...
            hidePleaseWait();
            if (res.data.IsSuccess && res.data.Data) {
                down_file(base_url + "//" + res.data.Data.ResponseId, "partyWiseProductRate.xlsx");
            }

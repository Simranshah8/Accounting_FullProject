app.controller('PurchaseRateCtrl', function ($scope, $filter, $http, $timeout, GlobalServices) {
    ...
    $scope.CallSaveUpdateProductType = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Inventory/Creation/SavePurchaseRateTypes",
    ...
    $scope.getProductTypeById = function (beData) {
        ...
        $http({
            method: 'POST',
            url: base_url + "Inventory/Creation/getPurchaseRateTypesById",
            dataType: "json",
            data: JSON.stringify(para)
        }).then(function (res) {
            $scope.loadingstatus = "stop";
    ...
    $scope.deleteProductType = function (refData, ind) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $http({
                    method: 'POST',
                    url: base_url + "Inventory/Creation/DeletePurchaseRateTypes",
                    dataType: "json",
                    data: JSON.stringify(para)
                }).then(function (res) {
                    hidePleaseWait();

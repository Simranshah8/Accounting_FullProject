app.controller("AllowLedgerGroupForAdditionalCostPurchase", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'AllowLedgerGroupForAdditionalCostPurchase';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            AllowLedgerGroupForAdditionalCostPurchase: 1

        };

        $scope.searchData = {
            AllowLedgerGroupForAdditionalCostPurchase: ''

        };

        $scope.perPage = {
            AllowLedgerGroupForAdditionalCostPurchase: GlobalServices.getPerPageRow(),

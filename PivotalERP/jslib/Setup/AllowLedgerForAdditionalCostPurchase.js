app.controller("AllowLedgerForAdditionalCostPurchase", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'AllowLedgerForAdditionalCostPurchase';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            AllowLedgerForAdditionalCostPurchase: 1

        };

        $scope.searchData = {
            AllowLedgerForAdditionalCostPurchase: ''

        };

        $scope.perPage = {
            AllowLedgerForAdditionalCostPurchase: GlobalServices.getPerPageRow(),

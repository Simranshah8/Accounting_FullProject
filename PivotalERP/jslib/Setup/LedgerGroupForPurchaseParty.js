app.controller("LedgerGroupForPurchaseParty", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'LedgerGroupForPurchaseParty';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            LedgerGroupForPurchaseParty: 1

        };

        $scope.searchData = {
            LedgerGroupForPurchaseParty: ''

        };

        $scope.perPage = {
            LedgerGroupForPurchaseParty: GlobalServices.getPerPageRow(),

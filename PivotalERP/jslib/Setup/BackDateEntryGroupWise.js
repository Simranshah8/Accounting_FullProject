app.controller("BackDateEntryGroupWise", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'BackDateEntryGroupWise';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            BackDateEntryGroupWise: 1

        };

        $scope.searchData = {
            BackDateEntryGroupWise: ''

        };

        $scope.perPage = {
            BackDateEntryGroupWise: GlobalServices.getPerPageRow(),

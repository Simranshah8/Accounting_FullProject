app.controller("AllowLedgerGroupForAdditionalCostSales", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'AllowLedgerGroupForAdditionalCostSales';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            AllowLedgerGroupForAdditionalCostSales: 1

        };

        $scope.searchData = {
            AllowLedgerGroupForAdditionalCostSales: ''

        };

        $scope.perPage = {
            AllowLedgerGroupForAdditionalCostSales: GlobalServices.getPerPageRow(),

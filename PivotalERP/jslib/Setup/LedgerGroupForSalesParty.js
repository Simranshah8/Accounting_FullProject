app.controller("LedgerGroupForSalesParty", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'LedgerGroupForSalesParty';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            LedgerGroupForSalesParty: 1

        };

        $scope.searchData = {
            LedgerGroupForSalesParty: ''

        };

        $scope.perPage = {
            LedgerGroupForSalesParty: GlobalServices.getPerPageRow(),

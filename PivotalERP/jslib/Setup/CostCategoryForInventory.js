...
app.controller("CostCategoryForInventory", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'CostCategoryForInventory';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            CostCategoryForInventory: 1

        };

        $scope.searchData = {
            CostCategoryForInventory: ''

        };

        $scope.perPage = {
            CostCategoryForInventory: GlobalServices.getPerPageRow(),

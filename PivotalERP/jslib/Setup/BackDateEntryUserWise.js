app.controller("BackDateEntryUserWise", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'BackDateEntryUserWise';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            BackDateEntryUserWise: 1

        };

        $scope.searchData = {
            BackDateEntryUserWise: ''

        };

        $scope.perPage = {
            BackDateEntryUserWise: GlobalServices.getPerPageRow(),

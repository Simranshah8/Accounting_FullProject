app.controller("AllowVoucherWiseProductGroup", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'AllowVoucherWiseProductGroup';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            AllowVoucherWiseProductGroup: 1

        };

        $scope.searchData = {
            AllowVoucherWiseProductGroup: ''

        };

        $scope.perPage = {
            AllowVoucherWiseProductGroup: GlobalServices.getPerPageRow(),

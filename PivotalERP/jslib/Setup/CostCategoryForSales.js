...
app.controller("CostCategoryForSales", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'CostCategoryForSales';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            CostCategoryForSales: 1

        };

        $scope.searchData = {
            CostCategoryForSales: ''

        };

        $scope.perPage = {
            CostCategoryForSales: GlobalServices.getPerPageRow(),

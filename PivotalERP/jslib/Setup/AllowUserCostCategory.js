app.controller("AllowUserWiseCostCategory", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'AllowUserWiseCostCategory';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            AllowUserWiseCostCategory: 1

        };

        $scope.searchData = {
            AllowUserWiseCostCategory: ''

        };

        $scope.perPage = {
            AllowUserWiseCostCategory: GlobalServices.getPerPageRow(),

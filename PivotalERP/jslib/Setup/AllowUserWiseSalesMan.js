app.controller("AllowUserWiseSalesMan", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'AllowUserWiseSalesMan';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            AllowUserWiseSalesMan: 1

        };

        $scope.searchData = {
            AllowUserWiseSalesMan: ''

        };

        $scope.perPage = {
            AllowUserWiseSalesMan: GlobalServices.getPerPageRow(),

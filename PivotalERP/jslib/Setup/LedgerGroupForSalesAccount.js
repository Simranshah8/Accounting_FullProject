app.controller("LedgerGroupForSalesAccount", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'LedgerGroupForSalesAccount';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            LedgerGroupForSalesAccount: 1

        };

        $scope.searchData = {
            LedgerGroupForSalesAccount: ''

        };

        $scope.perPage = {
            LedgerGroupForSalesAccount: GlobalServices.getPerPageRow(),

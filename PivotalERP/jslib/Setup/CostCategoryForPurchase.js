...
app.controller("CostCategoryForPurchase", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'CostCategoryForPurchase';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            CostCategoryForPurchase: 1

        };

        $scope.searchData = {
            CostCategoryForPurchase: ''

        };

        $scope.perPage = {
            CostCategoryForPurchase: GlobalServices.getPerPageRow(),

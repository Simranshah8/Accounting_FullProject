app.controller("DealerUserCtrl", function ($scope, $http, $filter, $timeout, GlobalServices) {
    ...
    $scope.GetAllDealerUser = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Setup/Security/GetAllDealerUser",
            dataType: "json",            
        }).then(function (res) {
            $scope.loadingstatus = "stop";
            hidePleaseWait();
    ...
    $scope.GenerateUser = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Setup/Security/GenDealerUser",
            dataType: "json",
...
app.controller("AllUserCtrl", function ($scope, $http, $filter, $timeout, GlobalServices) {
    ...
    $scope.GetAllDealerUser = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Setup/Security/GetDealerAgentUsers",
            dataType: "json",
        }).then(function (res) {
            $scope.loadingstatus = "stop";
            hidePleaseWait();

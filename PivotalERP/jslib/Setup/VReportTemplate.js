app.controller("vreportTemplatesCntrl", function ($scope, $http, $filter, GlobalServices) {
    ...
    function LoadData() {
        ...
        $http({
            method: "GET",
            url: base_url + "Account/Creation/GetAllVoucherWithEnum",
            dataType: "json"
        }).then(function (res) {
            hidePleaseWait();
            $scope.loadingstatus = "stop";
    ...
    $scope.GetAllReportTemplates = function () {
        ...
        $http({
            method: "post",
            url: base_url + "Setup/Security/GetVReportTemplates",
            dataType: "json",
    ...
    $scope.AddNewReportTemplate = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Setup/Security/SaveUpdateVReportTemplates",
    ...
    $scope.updateReportTemplates = function (beData) {
    ...
    $scope.deleteReportTemplate = function (beData) {
        ...
        if (ans) {
            var getData = $http({
                method: "post",
                url: base_url + "Setup/Security/DeleteVReportTemplates",

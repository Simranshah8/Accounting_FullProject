app.controller("AllowLedgerForAdditionalCostSales", function ($scope, $http, GlobalServices, $timeout) {
    $scope.Title = 'AllowLedgerForAdditionalCostSales';
    ...
    function LoadData() {
        ...
        $scope.currentPages = {
            AllowLedgerForAdditionalCostSales: 1

        };

        $scope.searchData = {
            AllowLedgerForAdditionalCostSales: ''

        };

        $scope.perPage = {
            AllowLedgerForAdditionalCostSales: GlobalServices.getPerPageRow(),

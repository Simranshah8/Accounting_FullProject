app.controller('VehicleEntry', function ($scope, $http, $timeout, $filter, GlobalServices) {
	...
	$scope.LoadData = function () {
		...
		$scope.TranSearchOptions = [   { text: 'Serial No.', value: 'V.EngineNo', searchType: 'text' },  { text: 'EntryNo', value: 'V.AutoNumber', searchType: 'text' }];
	...
	$scope.AddVehicleEntry = function () {
		...
		$scope.beData.ChSrlNo = $scope.beData.EngineNo;
		$scope.beData.RegdNo = $scope.beData.EngineNo;

app.controller('EmployeeController', function ($scope, $http, $timeout, $filter, GlobalServices) {
    ...
    $scope.LoadData = function () {
        ...
        $http({
            method: 'GET',
            url: base_url + "Payroll/Master/GetAllNationality",
            dataType: "json"
        }).then(function (res) {
            hidePleaseWait();
        ...
        $http({
            method: 'GET',
            url: base_url + "Payroll/Master/GetAllDisabilities",
            dataType: "json"
        }).then(function (res) {
            hidePleaseWait();
            $scope.loadingstatus = "stop";
        ...
        $http({
            method: 'GET',
            url: base_url + "Payroll/Master/GetAllEmployee",
            dataType: "json"
        }).then(function (res) {
            hidePleaseWait();
            $scope.loadingstatus = "stop";
        ...
        $http({
            method: 'GET',
            url: base_url + "Payroll/Master/GetAllArea",
            dataType: "json"
        }).then(function (res) {
            hidePleaseWait();
            $scope.loadingstatus = "stop";
        ...
        $http({
            method: 'GET',
            url: base_url + "Payroll/Master/GetAllBank",
            dataType: "json"
        }).then(function (res) {
            hidePleaseWait();
            $scope.loadingstatus = "stop";
        ...
        $http({
            method: 'GET',
            url: base_url + "Payroll/Master/GetAllCompanyList",
            dataType: "json"
        }).then(function (res) {
            hidePleaseWait();
            $scope.loadingstatus = "stop";
        ...
        $http({
            method: 'GET',
            url: base_url + "Payroll/Master/GetAllCostCenter",
            dataType: "json"
        }).then(function (res) {
            hidePleaseWait();
            $scope.loadingstatus = "stop";
    ...
    $scope.ChangeDOB = function () {
        if (!$scope.newDet.DobADDet) {
            ...
            var dobAD = $filter('date')(new Date($scope.newDet.DobADDet.dateAD), 'yyyy-MM-dd');
    ...
    function OnClickDefault() {
        ...
        document.getElementById('emp-add-question').onclick = function () {
            $('#EmployeeAdd-tab').tab('show');
        }
        document.getElementById('back-emp-det-question').onclick = function () {
            $('#EmployeeDet-tab').tab('show');
        }

        document.getElementById('emergency-contact-question').onclick = function () {
            $('#Emergency-tab').tab('show');
        }
        document.getElementById('back-emp-add-question').onclick = function () {
            $('#EmployeeAdd-tab').tab('show');
        }

        document.getElementById('office-detail-question').onclick = function () {
            $('#Office-tab').tab('show');
        }
        document.getElementById('back-emg-det-question').onclick = function () {
            $('#Emergency-tab').tab('show');


        }
        document.getElementById('PF-question').onclick = function () {
            $('#PFSSF-tab').tab('show');

        }
        document.getElementById('back-off-det-question').onclick = function () {
            $('#Office-tab').tab('show');

        }
        document.getElementById('bank-question').onclick = function () {
            $('#BankAcc-tab').tab('show');

        }
        document.getElementById('back-pf-det-question').onclick = function () {
            $('#PFSSF-tab').tab('show');

        }
        document.getElementById('ins-question').onclick = function () {
            $('#Insurance-tab').tab('show');

        }
        document.getElementById('back-bank-question').onclick = function () {
            $('#BankAcc-tab').tab('show');

        }
        document.getElementById('acc-det-question').onclick = function () {
            $('#Account-tab').tab('show');

        }
        document.getElementById('back-acc-question').onclick = function () {
            $('#Insurance-tab').tab('show');

        }
        document.getElementById('Academic-question').onclick = function () {
            $('#Qualification-tab').tab('show');

        }
        document.getElementById('back-det-question').onclick = function () {
            $('#Account-tab').tab('show');

        }
        document.getElementById('work-question').onclick = function () {
            $('#Experience-tab').tab('show');

        }
        document.getElementById('back-academic-question').onclick = function () {
            $('#Qualification-tab').tab('show');

        }
        document.getElementById('supervisor-question').onclick = function () {
            $('#Supervisor-tab').tab('show');

        }
        document.getElementById('back-work-question').onclick = function () {
            $('#Experience-tab').tab('show');

        }

        document.getElementById('att-question').onclick = function () {
            $('#Attachment-tab').tab('show');

        }
        document.getElementById('back-supervisor-question').onclick = function () {
            $('#Supervisor-tab').tab('show');
    ...
    $scope.CallSaveUpdateEmpProfile = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveEmployeeDetails",
            ...
            data: {
                jsonData: $scope.newDet, emPhoto: photo, emCitiFront: citiFront, emCitiBack: citiBack
            }
        }).then(function (res) {
    ...
    $scope.SaveEmployeeAdd = function () {
        if ($scope.IsValidEEmpCode() == true) {
            if ($scope.confirmMSG.Accept == true) {
                var saveModify = $scope.newDet.Mode;
                Swal.fire({
    ...
    $scope.CallSaveUpdateEmpAdd = function () {
        $scope.loadingstatus = "running";
        showPleaseWait();
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveEmployeeAdd",
            headers: { 'Content-Type': undefined },
    ...
    $scope.UpdateEmpEmergency = function () {
        $scope.loadingstatus = "running";
        showPleaseWait();
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveEmpEmergency",
            headers: { 'Content-Type': undefined },
    ...
    $scope.UpdateOfficeDet = function () {
        $scope.loadingstatus = "running";
        showPleaseWait();
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveOfficeDetails",
            headers: { 'Content-Type': undefined },
    ...
    $scope.UpdatePfSsfCit = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/ModifyPfSsfCit",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
            ...
            data: {
                jsonData: $scope.newDet, pfAttach, emsfAttach: sfAttach, emcitAttach: citAttach, emgratAttach: gratAttach
            }
        }).then(function (res) {
            $scope.loadingstatus = "stop";
            hidePleaseWait();
    ...
    $scope.UpdateBankDetails = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveUpdateBankDetails",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
    ...
    $scope.UpdateInsurance = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveUpdateInsurance",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
            ...
            data: {
                jsonData: $scope.newDet, emliAttach: liAttach, emhiAttach: hiAttach
            }
        }).then(function (res) {
            $scope.loadingstatus = "stop";
            hidePleaseWait();
    ...
    $scope.SaveUpdateAccountDet = function () {
        $scope.loadingstatus = "running";
        showPleaseWait();
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveUpdateAccountDet",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
    ...
    $scope.UpdateQualification = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveUpdateQualification",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
    ...
    $scope.UpdateExperience = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveUpdateExperience",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
    ...
    $scope.UpdateSupervisor= function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveUpdateSupervisor",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
                var formData = new FormData();
                formData.append("jsonData", angular.toJson(data.jsonData));
    ...
    $scope.UpdateDocument= function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveUpdateDocument",
            headers: { 'Content-Type': undefined },
            transformRequest: function (data) {
                var formData = new FormData();
                formData.append("jsonData", angular.toJson(data.jsonData));
            ...
            data: {
                jsonData: $scope.newDet, files: filesColl
            }
        }).then(function (res) {
            $scope.loadingstatus = "stop";
            hidePleaseWait();
    ...
    $scope.getEmployeeById = function (refData) {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/getEmployeeById",
            dataType: "json",
    ...
    $scope.DelEmployeeById = function (refData) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $http({
                    method: 'POST',
                    url: base_url + "Payroll/Master/DeleteEmployee",
                    dataType: "json",
                    data: JSON.stringify(para)
                }).then(function (res) {
                    hidePleaseWait();

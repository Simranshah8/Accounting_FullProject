app.controller('EmployeeProfileController', function ($scope, $http, $timeout, $filter, GlobalServices) {
    ...
    $scope.CallSaveUpdateEmpProfile = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/SaveEmployee",
    ...
    $scope.getEmployeeById = function (refData) {
        ...
        $http({
            ...
            if (res.data.IsSuccess && res.data.Data) {
                ...
                if ($scope.newDet.DobAD)
                    $scope.newDet.DobAD = new Date($scope.newDet.DobAD);
    ...
    $scope.getDocViewById = function (refData) {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/GetDocViewById",
            dataType: "json",
            data: JSON.stringify(para)
        }).then(function (res) {
            hidePleaseWait();
    ...
    $scope.GetAutoEmpNo = function () {
        ...
        $http({
            method: 'POST',
            url: base_url + "Payroll/Master/GetAutoEmpNo",
            dataType: "json"

...
{
    public partial class RdlCompetitorSales : System.Web.Mvc.ViewPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack && !Loaded)
            {
                ...
                string path = @"\Report\MIS\CompetitorSales.rdlc";
                ...
                var dataColl = new Dynamic.DataAccess.MIS.CompetitorSalesDB(user.HostName, user.DBName).getCompetitorSalesRpt(user.UserId);

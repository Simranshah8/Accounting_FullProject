...
{
    public class EmployeeWiseWeekend : ResponeValues
    {
    ...
    public class EmployeeWiseWeekendCollections : System.Collections.Generic.List<EmployeeWiseWeekend>
    {
        public EmployeeWiseWeekendCollections()
        {
            ResponseMSG = "";
        }

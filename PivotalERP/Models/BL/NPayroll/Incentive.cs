...
namespace Dynamic.BL.NPayroll
{
    ...
    {
        DA.NPayroll.IncentiveDB db = null;
        int _UserId = 0;
        public Incentive(int UserId, string hostName, string dbName)
        {
            this._UserId = UserId;
            db = new DA.NPayroll.IncentiveDB(hostName, dbName);
        }
        public ResponeValues SaveFormData(Dynamic.BE.NPayroll.Incentive beData)
        {
        ...
        public Dynamic.BE.NPayroll.IncentiveCollections GetAllIncentive(int EntityId)
        {
            return db.getAllIncentive(_UserId, EntityId);
        }

        public Dynamic.BE.NPayroll.Incentive GetIncentiveById(int EntityId, int IncentiveId)
        {
        ...
        public ResponeValues IsValidData(ref Dynamic.BE.NPayroll.Incentive beData, bool IsModify)
        {

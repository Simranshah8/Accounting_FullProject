...
{
    public class LoanCreation : ISaveModifyDelete<Dynamic.BusinessEntity.Finance.LoanCreation>, IDataLoading<Dynamic.BusinessEntity.Finance.LoanCreation>, IGetDataByRow<Dynamic.BusinessEntity.Finance.LoanCreation>
    {
        Dynamic.DataAccess.Finance.LoanCreationDB db = new DataAccess.Finance.LoanCreationDB();
       ...
       public ResponeValues SaveFormData(Dynamic.BusinessEntity.Finance.LoanCreation beData)
        ...
        {
            return db.Delete(beData.TranId);
        }

...
{
    internal class AllowExpenseCategoryDB
    {
        DataAccessLayer1 dal = null;
        public AllowExpenseCategoryDB(string hostName, string dbName)
        {
            dal = new DataAccessLayer1(hostName, dbName);
        }

        public ResponeValues UpdateAllowExpenseCategory(int UserId, List<Dynamic.BE.NPayroll.AllowExpenseCategory> DataColl)
        {
            ...
            try
            {
                ...
                System.Data.SqlClient.SqlParameter sqlParam = cmd.Parameters.AddWithValue("@AllowExpenseCategoryColl", tableAllocation);
                sqlParam.SqlDbType = System.Data.SqlDbType.Structured;
                cmd.CommandText = "usp_AddAllowExpenseCategory";
                cmd.ExecuteNonQuery();
        ...
        public Dynamic.BE.NPayroll.EmployeeForAllowExpenseCategoryCollections getAllAllowExpenseCategory(int UserId, int EntityId, int? BranchId, int? DepartmentId, int? CategoryId)
        {
            ...
            cmd.CommandText = "usp_GetEmpForAllowExpenseCategory";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
                    Dynamic.BE.NPayroll.EmployeeForAllowExpenseCategory beData = new Dynamic.BE.NPayroll.EmployeeForAllowExpenseCategory();

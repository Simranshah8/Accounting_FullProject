...
{
    internal class IncentiveTypeDB
    {
        DataAccessLayer1 dal = null;
        public IncentiveTypeDB(string hostName, string dbName)
        {
            dal = new DataAccessLayer1(hostName, dbName);
        }
        public ResponeValues SaveUpdate(Dynamic.BE.NPayroll.IncentiveType beData, bool isModify)
        {
            ...
            if (isModify)
            {
                cmd.CommandText = "usp_UpdateIncentiveType";
            }
            else
            {
                cmd.Parameters[7].Direction = System.Data.ParameterDirection.Output;
                cmd.CommandText = "usp_AddIncentiveType";
            }
        ...
        public Dynamic.BE.NPayroll.IncentiveTypeCollections getAllIncentiveType(int UserId, int EntityId)
        {
            ...
            cmd.CommandText = "usp_GetAllIncentiveType";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
                    Dynamic.BE.NPayroll.IncentiveType beData = new Dynamic.BE.NPayroll.IncentiveType();
        ...
        public Dynamic.BE.NPayroll.IncentiveType getIncentiveTypeById(int UserId, int EntityId, int TranId)
        {
            Dynamic.BE.NPayroll.IncentiveType beData = new Dynamic.BE.NPayroll.IncentiveType();
            ...
            cmd.Parameters.AddWithValue("@UserId", UserId);
            cmd.Parameters.AddWithValue("@EntityId", EntityId);
            cmd.CommandText = "usp_GetIncentiveTypeById";
            try
            {
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
                {
                    beData = new Dynamic.BE.NPayroll.IncentiveType();
                    beData.TranId = reader.GetInt32(0);
                    if (!(reader[1] is DBNull)) beData.Name = reader.GetString(1);
                    if (!(reader[2] is DBNull)) beData.Code = reader.GetString(2);
                    if (!(reader[3] is DBNull)) beData.PayHeadingId = reader.GetInt32(3);
        ...
        public ResponeValues DeleteById(int UserId, int EntityId, int TranId)
        {
            ...
            cmd.Parameters.AddWithValue("@EntityId", EntityId);
            cmd.Parameters.AddWithValue("@TranId", TranId);
            cmd.CommandText = "usp_DelIncentiveTypeById";
            cmd.Parameters.Add("@ResponseMSG", System.Data.SqlDbType.NVarChar, 254);
            cmd.Parameters.Add("@IsSuccess", System.Data.SqlDbType.Bit);
            cmd.Parameters.Add("@ErrorNumber", System.Data.SqlDbType.Int);

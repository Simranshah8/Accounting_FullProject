...
namespace Dynamic.DA.AppCMS.Creation
{
    internal class VideosDB
    {
        ...
        public ResponeValues SaveUpdate(Dynamic.BE.AppCMS.Creation.Videos beData, bool isModify)
        {
        ...
        public Dynamic.BE.AppCMS.Creation.VideosCollections getAllVideos(int UserId, int EntityId, string BranchCode)
        {
            Dynamic.BE.AppCMS.Creation.VideosCollections dataColl = new Dynamic.BE.AppCMS.Creation.VideosCollections();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    Dynamic.BE.AppCMS.Creation.Videos beData = new Dynamic.BE.AppCMS.Creation.Videos();
        ...
        public Dynamic.BE.AppCMS.Creation.Videos getVideosById(int UserId, int EntityId, int VideosId)
        {
            Dynamic.BE.AppCMS.Creation.Videos beData = new Dynamic.BE.AppCMS.Creation.Videos();
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    beData = new Dynamic.BE.AppCMS.Creation.Videos();
                    beData.VideosId = reader.GetInt32(0);
                    if (!(reader[1] is DBNull)) beData.Title = reader.GetString(1);
                    if (!(reader[2] is DBNull)) beData.Description = reader.GetString(2);
                    if (!(reader[3] is DBNull)) beData.AddUrl = reader.GetString(3);

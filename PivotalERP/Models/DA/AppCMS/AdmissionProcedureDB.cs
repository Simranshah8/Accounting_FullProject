...
namespace Dynamic.DA.AppCMS.Creation
{
    internal class AdmissionProcedureDB
    {
        ...
        public ResponeValues SaveUpdate(Dynamic.BE.AppCMS.Creation.AdmissionProcedure beData, bool isModify)
        {
        ...
        public Dynamic.BE.AppCMS.Creation.AdmissionProcedureCollections getAllAdmissionProcedure(int UserId, int EntityId, string BranchCode)
        {
            Dynamic.BE.AppCMS.Creation.AdmissionProcedureCollections dataColl = new Dynamic.BE.AppCMS.Creation.AdmissionProcedureCollections();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    Dynamic.BE.AppCMS.Creation.AdmissionProcedure beData = new Dynamic.BE.AppCMS.Creation.AdmissionProcedure();
        ...
        public Dynamic.BE.AppCMS.Creation.AdmissionProcedure getAdmissionProcedureById(int UserId, int EntityId, int AdmissionProcedureId)
        {
            Dynamic.BE.AppCMS.Creation.AdmissionProcedure beData = new Dynamic.BE.AppCMS.Creation.AdmissionProcedure();
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    beData = new Dynamic.BE.AppCMS.Creation.AdmissionProcedure();
                    beData.AdmissionProcedureId = reader.GetInt32(0);
                    if (!(reader[1] is DBNull)) beData.Title = reader.GetString(1);
                    if (!(reader[2] is DBNull)) beData.Description = reader.GetString(2);
                    if (!(reader[3] is DBNull)) beData.ImagePath = reader.GetString(3);

...
namespace Dynamic.DA.AppCMS.Creation
{
    internal class NepaliMonthDB
    {
        ...
        public ResponeValues SaveUpdate(int UserId, Dynamic.BE.AppCMS.Creation.NepaliMonthCollections dataColl)
        {
        ...
        public Dynamic.BE.AppCMS.Creation.NepaliMonthCollections getAllMonthName(int UserId, int EntityId)
        {
            Dynamic.BE.AppCMS.Creation.NepaliMonthCollections dataColl = new Dynamic.BE.AppCMS.Creation.NepaliMonthCollections();
            dal.OpenConnection();
            System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@UserId", UserId);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    Dynamic.BE.AppCMS.Creation.NepaliMonth beData = new BE.AppCMS.Creation.NepaliMonth();

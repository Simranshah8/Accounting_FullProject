...
namespace Dynamic.DA.AppCMS.Creation
{
    internal class RulesRegulationDB
    {
        ...
        public ResponeValues SaveUpdate(Dynamic.BE.AppCMS.Creation.RulesRegulation beData, bool isModify)
        {
        ...
        public Dynamic.BE.AppCMS.Creation.RulesRegulationCollections getAllRulesRegulation(int UserId, int EntityId, string BranchCode)
        {
            Dynamic.BE.AppCMS.Creation.RulesRegulationCollections dataColl = new Dynamic.BE.AppCMS.Creation.RulesRegulationCollections();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    Dynamic.BE.AppCMS.Creation.RulesRegulation beData = new Dynamic.BE.AppCMS.Creation.RulesRegulation();
        ...
        public Dynamic.BE.AppCMS.Creation.RulesRegulation getRulesRegulationById(int UserId, int EntityId, int RulesRegulationId)
        {
            Dynamic.BE.AppCMS.Creation.RulesRegulation beData = new Dynamic.BE.AppCMS.Creation.RulesRegulation();
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    beData = new Dynamic.BE.AppCMS.Creation.RulesRegulation();
                    beData.RulesRegulationId = reader.GetInt32(0);
                    if (!(reader[1] is DBNull)) beData.Title = reader.GetString(1);
                    if (!(reader[2] is DBNull)) beData.Description = reader.GetString(2);
                    if (!(reader[3] is DBNull)) beData.ImagePath = reader.GetString(3);

...
namespace Dynamic.DA.AppCMS.Creation
{
    internal class ContactDB
    {
        ...
        public ResponeValues SaveUpdate(Dynamic.BE.AppCMS.Creation.Contact beData, bool isModify)
        {
        ...
        public Dynamic.BE.AppCMS.Creation.Contact getContactById(int UserId, int EntityId, int ContactId)
        {
            Dynamic.BE.AppCMS.Creation.Contact beData = new Dynamic.BE.AppCMS.Creation.Contact();
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    beData = new Dynamic.BE.AppCMS.Creation.Contact();

...
namespace Dynamic.DA.Hospital
{
    ...
    internal class RoomDB
    {
        ...
        public ResponeValues SaveUpdate(BE.Hospital.Room beData, bool isModify)
        {
        ...
        public BE.Hospital.RoomCollections getAllRoom(int UserId, int EntityId)
        {
            BE.Hospital.RoomCollections dataColl = new BE.Hospital.RoomCollections();
            dal.OpenConnection();
            System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@UserId", UserId);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    BE.Hospital.Room beData = new BE.Hospital.Room();
        ...
        public BE.Hospital.Room getRoomById(int UserId, int EntityId, int RoomId)
        {
            BE.Hospital.Room beData = new BE.Hospital.Room();
            dal.OpenConnection();
            System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();

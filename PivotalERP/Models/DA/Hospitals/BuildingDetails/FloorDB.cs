...
namespace Dynamic.DA.Hospital
{
    ...
    internal class FloorDB
    {
        ...
        public ResponeValues SaveUpdate(BE.Hospital.Floor beData, bool isModify)
        {
        ...
        public BE.Hospital.FloorCollections getAllFloor(int UserId, int EntityId)
        {
            BE.Hospital.FloorCollections dataColl = new BE.Hospital.FloorCollections();
            dal.OpenConnection();
            System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@UserId", UserId);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    BE.Hospital.Floor beData = new BE.Hospital.Floor();
                    if (!(reader[0] is DBNull)) beData.FloorId = reader.GetInt32(0);
        ...
        public BE.Hospital.Floor getFloorById(int UserId, int EntityId, int FloorId)
        {
            BE.Hospital.Floor beData = new BE.Hospital.Floor();
            dal.OpenConnection();
            System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();

...
{
    internal  class WorkingShiftDB
    {
        DataAccessLayer1 dal = null;
        public WorkingShiftDB(string hostName, string dbName)
        {
        ...
        public ResponeValues SaveUpdate(BE.Attendance.WorkingShift beData, bool isModify)
        {
            ...
            if (isModify)
            {
                ...
                cmd.CommandText = "sp_UpdateWorkingShift";
            }
            else
            {                
                cmd.Parameters.Add("@WorkingShiftId", System.Data.SqlDbType.Int);
                cmd.CommandText = "sp_AddWorkingShift";
        ...
        public ResponeValues DeleteById(int UserId, int EntityId, int WorkingShiftId)
        {
            ResponeValues resVal = new ResponeValues();
            ...
            cmd.CommandText = "usp_DelWorkingShiftById";
            cmd.Parameters.Add("@ResponseMSG", System.Data.SqlDbType.NVarChar, 254);
            cmd.Parameters.Add("@IsSuccess", System.Data.SqlDbType.Bit);
            cmd.Parameters.Add("@ErrorNumber", System.Data.SqlDbType.Int);
        ...
        public BE.Attendance.WorkingShiftCollections getAllWorkingShift(int UserId)
        {
            ...
            try
            {
                ...
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@UserId", UserId);
                cmd.CommandText = "sp_GetAllWorkingShift";
                System.Data.SqlClient.SqlDataReader reader = cmd.ExecuteReader();
                while (reader.Read())
                {
                    BE.Attendance.WorkingShift beData = new BE.Attendance.WorkingShift();
                    beData.WorkingShiftId = reader.GetInt32(0);
        ...
        public BE.Attendance.WorkingShift getWorkingShiftById(int WorkingShiftId, int UserId)
        {
            BE.Attendance.WorkingShift beData = new BE.Attendance.WorkingShift();
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@WorkingShiftId", WorkingShiftId);
                cmd.Parameters.AddWithValue("@UserId", UserId);
                cmd.CommandText = "sp_GetWorkingShiftById";
                ...
                if (reader.Read())
                {
                    ...
                    if (!(reader[43] is System.DBNull)) beData.IsDefault = Convert.ToBoolean(reader[43]);

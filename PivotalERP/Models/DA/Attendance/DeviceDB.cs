...
namespace Dynamic.DA.Attendance
{
    internal class DeviceDB
    {
        ...
        public BE.Attendance.DeviceCollections getAllDevice(int UserId, int EntityId)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (!(reader[4] is DBNull)) beData.DeviceCompany =(Dynamic.BE.Attendance.DEVICECOMPANY) reader.GetInt32(4);
                    dataColl.Add(beData);
                }
                reader.Close();
        ...
        public RE.Attendance.EmployeeDailyAttendanceCollections getEmpAbsentList(int UserId, DateTime forDate, string branchIdColl = "",int? companyId=null,int? DepartmentId=null,int? DesignationId=null)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (!(reader[3] is DBNull)) beData.EnrollNo = Convert.ToInt64(reader[3]);
                    ...
                    if (!(reader[14] is DBNull)) beData.GroupName = reader.GetString(14);
        ...
        public RE.Attendance.EmployeeDailyAttendanceCollections getEmpDailyAttendance(int UserId, DateTime forDate,string branchIdColl="",bool isManualOnly=false,int empType=1, string DepartmentIdColl = "", string GroupIdColl = "",int? CompanyId=null,bool ApproveOnly=true)
        {
            RE.Attendance.EmployeeDailyAttendanceCollections dataColl = new RE.Attendance.EmployeeDailyAttendanceCollections();
            dal.OpenConnection();
            System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    try
                    {
                        ...
                        if (!(reader[40] is DBNull)) beData.GroupName = reader.GetString(40);
                        if (!(reader[41] is DBNull)) beData.LevelName = reader.GetString(41);
                        if (!(reader[42] is DBNull)) beData.ServiceType = reader.GetString(42);
                        if (!(reader[43] is DBNull)) beData.Company = reader.GetString(43);

                        if (!(reader["InPhotoPath"] is DBNull)) beData.InPhotoPath = Convert.ToString(reader["InPhotoPath"]);
                        if (!(reader["OutPhotoPath"] is DBNull)) beData.OutPhotoPath = Convert.ToString(reader["OutPhotoPath"]); 
                    }
                    catch { }
                    ...
                    beData.OTHour = ConvertMinuteToHR(Convert.ToInt32(beData.OTDuration));
        ...
        public RE.Attendance.EmpMonthlyAttendanceLogCollections getEmpMonthlyAttendance(int UserId, int YearId, int MonthId, string BranchIdColl, int empType, int? CompanyRelationshipId, string DepartmentIdColl = "", string GroupIdColl = "", bool ShowShiftWise = false)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (!(reader[1] is System.DBNull)) beData.EnrollNumber = Convert.ToInt64(reader[1]);
                    ...
                    try
                    {
                        ...
                        if (!(reader[101] is System.DBNull)) beData.TotalPayableDays = Convert.ToDouble(reader[101]);
                        if (!(reader[102] is System.DBNull)) beData.LeaveOT = Convert.ToDouble(reader[102]);
                    }
                    catch { }

                    if (beData.OTDuration > 0)
                        beData.OTHour = ConvertMinuteToHR(beData.OTDuration);
                ...
                if (!(cmd.Parameters[6].Value is DBNull))
                    dateFrom = Convert.ToDateTime(cmd.Parameters[6].Value);

                if (!(cmd.Parameters[7].Value is DBNull))
                    dateTo = Convert.ToDateTime(cmd.Parameters[7].Value);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    try
                    {
                        ...
                        if (!(reader[37] is System.DBNull)) beData.EnrollNumber = Convert.ToInt64(reader[37]);
                        ...
                        if (!(reader[42] is DBNull)) beData.GroupName = reader.GetString(42);
                        if (!(reader[43] is DBNull)) beData.LevelName = reader.GetString(43);
                        if (!(reader[44] is DBNull)) beData.ServiceType = reader.GetString(44);
                        if (!(reader[45] is DBNull)) beData.Category = reader.GetString(45);
                        if (!(reader[46] is DBNull)) beData.Company = reader.GetString(46);
                    }
                    catch { }


                    if (beData.InTime.HasValue)
                        beData.InTimeStr = beData.InTime.Value.ToString("HH:mm tt");

                    if (beData.OutTime.HasValue)
                        beData.OutTimeStr = beData.OutTime.Value.ToString("HH:mm tt");
        ...
        private string ConvertMinuteToHR(double minute)
        {
            if (minute == 0)
                return "00:00";

            double hours = (minute - minute % 60) / 60;
            return hours.ToString().PadLeft(2, '0') + ":" + (minute - hours * 60).ToString().PadLeft(2, '0');
        }
        ...
        public RE.Attendance.EmpMonthlyAttendanceLogCollections getEmpYearAttendanceLog(int UserId,int EmployeeId, int? YearId,int? CostClassId, bool ShowShiftWise = false)
        {
            RE.Attendance.EmpMonthlyAttendanceLogCollections dataColl = new RE.Attendance.EmpMonthlyAttendanceLogCollections();

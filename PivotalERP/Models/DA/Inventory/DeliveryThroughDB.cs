...
namespace PivotalERP.DA
{
	...
	internal class DeliveryThroughDB
	{
		...
		public ResponeValues SaveUpdate(BE.DeliveryThrough beData, bool isModify)
		{
		...
		public BE.DeliveryThroughCollections getAllDeliveryThrough(int UserId, int EntityId)
		{
			BE.DeliveryThroughCollections dataColl = new BE.DeliveryThroughCollections();
			dal.OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
			cmd.CommandType = System.Data.CommandType.StoredProcedure;
			cmd.Parameters.AddWithValue("@UserId", UserId);
			...
			try
			{
				...
				while (reader.Read())
				{
					BE.DeliveryThrough beData = new BE.DeliveryThrough();
		...
		public BE.DeliveryThrough getDeliveryThroughById(int UserId, int EntityId, int DeliveryThroughId)
		{
			BE.DeliveryThrough beData = new BE.DeliveryThrough();
			dal.OpenConnection();
			System.Data.SqlClient.SqlCommand cmd = dal.GetCommand();
